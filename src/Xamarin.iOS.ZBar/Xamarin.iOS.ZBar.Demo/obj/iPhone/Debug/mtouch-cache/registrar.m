...
native_to_managed_trampoline_MonoTouch_Foundation_NSObject_NSObject_Disposer_Drain (id this, SEL sel, id p0)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_18, NULL, arg_ptrs, NULL);
	return NULL;
}
...
void *
native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBPeripheralManager__CBPeripheralManagerDelegate_WillRestoreState (id this, SEL sel, id p0, id p1)
{
	void *arg_ptrs [2];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBPeripheralManager__CBPeripheralManagerDelegate_CharacteristicSubscribed (id this, SEL sel, id p0, id p1, id p2)
{
	...
	NSObject *nsobj2 = (NSObject *) p2;
		...
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_63, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBPeripheralManager__CBPeripheralManagerDelegate_WriteRequestsReceived (id this, SEL sel, id p0, id p1)
{
	...
	if (p1) {
		...
		int j;
			MonoType *p_class;
		p = monotouch_get_parameter_type (method_66, 1);
...
native_to_managed_trampoline_MonoTouch_Foundation_NSMetadataQuery__NSMetadataQueryDelegate_ReplacementValueForAttributevalue (id this, SEL sel, id p0, NSString * p1, id p2)
{
	...
	NSObject *nsobj2 = (NSObject *) p2;
		...
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_70, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_GameKit_GKMatchmakerViewController__GKMatchmakerViewControllerDelegate_DidFindPlayers (id this, SEL sel, id p0, NSString * p1)
{
	...
	if (p1) {
		...
		int j;
			MonoType *p_class;
		p = monotouch_get_parameter_type (method_81, 1);
		e_class = mono_class_get_element_class (mono_class_from_mono_type (p));
		marr = mono_array_new (mono_domain_get (), e_class, [arr count]);
		for (j = 0; j < [arr count]; j++) {
...
void *
native_to_managed_trampoline_MonoTouch_SpriteKit_SKPhysicsWorld__SKPhysicsContactDelegate__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_MonoTouch_SpriteKit_SKPhysicsWorld__SKPhysicsContactDelegate_DidBeginContact (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_MonoTouch_SpriteKit_SKPhysicsWorld__SKPhysicsContactDelegate_DidEndContact (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
native_to_managed_trampoline_MonoTouch_Foundation_NSNetServiceBrowser__NSNetServiceBrowserDelegate_FoundService (id this, SEL sel, id p0, id p1, bool p2)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_106, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	arg_ptrs [2] = &p2;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIPageViewController__UIPageViewControllerDataSource_GetPreviousViewController (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_115, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIPageViewController__UIPageViewControllerDelegate_DidFinishAnimating (id this, SEL sel, id p0, bool p1, id p2, bool p3)
{
	...
	if (p2) {
		...
		int j;
			MonoType *p_class;
		p = monotouch_get_parameter_type (method_120, 2);
		e_class = mono_class_get_element_class (mono_class_from_mono_type (p));
		marr = mono_array_new (mono_domain_get (), e_class, [arr count]);
		for (j = 0; j < [arr count]; j++) {
			NSObject *nobj = [arr objectAtIndex: j];
			...
			p_class = mono_class_get_type (e_class);
			if (nobj) {
				mobj2 = get_nsobject_with_type_for_ptr (nobj, false, p_class);
			}
...
native_to_managed_trampoline_MonoTouch_UIKit_UIPageViewController__UIPageViewControllerDelegate_WillTransition (id this, SEL sel, id p0, id p1)
{
	...
	if (p1) {
		...
		int j;
			MonoType *p_class;
		p = monotouch_get_parameter_type (method_122, 1);
		e_class = mono_class_get_element_class (mono_class_from_mono_type (p));
		marr = mono_array_new (mono_domain_get (), e_class, [arr count]);
		for (j = 0; j < [arr count]; j++) {
			NSObject *nobj = [arr objectAtIndex: j];
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIPageViewController__UIPageViewControllerDelegate_SupportedInterfaceOrientations (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIPageViewController__UIPageViewControllerDelegate_GetPreferredInterfaceOrientationForPresentation (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIScreenEdgePanGestureRecognizer_Callback_Activated (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
native_to_managed_trampoline_MonoTouch_UIKit_UIPopoverController__UIPopoverControllerDelegate_WillReposition (id this, SEL sel, id p0, CGRect* p1, id* p2)
{
	...
	NSObject *nsobj2 = *(NSObject **) p2;
		MonoObject *mobj2 = NULL;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr (nsobj2, false, monotouch_get_parameter_type (method_131, 2));
		}
	arg_ptrs [2] = (int *) &mobj2;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIGestureRecognizer__UIGestureRecognizerDelegate_ShouldRequireFailureOf (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_149, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_MediaPlayer_MPMediaPickerController__MPMediaPickerControllerDelegate__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_158));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIToneCurve__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_162));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_NSTextStorage__NSTextStorageDelegate__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_NSTextStorage__NSTextStorageDelegate_WillProcessEditing (id this, SEL sel, id p0, int p1, NSRange p2, int p3)
{
	void *arg_ptrs [4];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_NSTextStorage__NSTextStorageDelegate_DidProcessEditing (id this, SEL sel, id p0, int p1, NSRange p2, int p3)
{
	void *arg_ptrs [4];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIView_UIViewAppearance_get_TintColor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIView_UIViewAppearance_set_TintColor (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_MonoTouch_AVFoundation_AVSpeechSynthesizer__AVSpeechSynthesizerDelegate__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_MonoTouch_AVFoundation_AVSpeechSynthesizer__AVSpeechSynthesizerDelegate_DidStartSpeechUtterance (id this, SEL sel, id p0, id p1)
{
	void *arg_ptrs [2];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_MonoTouch_AVFoundation_AVSpeechSynthesizer__AVSpeechSynthesizerDelegate_DidFinishSpeechUtterance (id this, SEL sel, id p0, id p1)
{
	void *arg_ptrs [2];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_181, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
void *
native_to_managed_trampoline_MonoTouch_AVFoundation_AVSpeechSynthesizer__AVSpeechSynthesizerDelegate_DidPauseSpeechUtterance (id this, SEL sel, id p0, id p1)
{
	void *arg_ptrs [2];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_MonoTouch_AVFoundation_AVSpeechSynthesizer__AVSpeechSynthesizerDelegate_DidContinueSpeechUtterance (id this, SEL sel, id p0, id p1)
{
	void *arg_ptrs [2];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_MonoTouch_AVFoundation_AVSpeechSynthesizer__AVSpeechSynthesizerDelegate_DidCancelSpeechUtterance (id this, SEL sel, id p0, id p1)
{
	void *arg_ptrs [2];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_MonoTouch_AVFoundation_AVSpeechSynthesizer__AVSpeechSynthesizerDelegate_WillSpeakRangeOfSpeechString (id this, SEL sel, id p0, NSRange p1, id p2)
{
	void *arg_ptrs [3];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	NSObject *nsobj2 = (NSObject *) p2;
		...
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_185, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIPrintInteractionController__UIPrintInteractionControllerDelegate_ChoosePaper (id this, SEL sel, id p0, id p1)
{
	...
	if (p1) {
		...
		int j;
			MonoType *p_class;
		p = monotouch_get_parameter_type (method_189, 1);
		e_class = mono_class_get_element_class (mono_class_from_mono_type (p));
		marr = mono_array_new (mono_domain_get (), e_class, [arr count]);
		for (j = 0; j < [arr count]; j++) {
			NSObject *nobj = [arr objectAtIndex: j];
...
native_to_managed_trampoline_MonoTouch_UIKit_UIPrintInteractionController__UIPrintInteractionControllerDelegate_WillDismissPrinterOptions (id this, SEL sel, id p0)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_192, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIPrintInteractionController__UIPrintInteractionControllerDelegate_WillStartJob (id this, SEL sel, id p0)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_194, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
float
native_to_managed_trampoline_MonoTouch_UIKit_UIPrintInteractionController__UIPrintInteractionControllerDelegate_CutLengthForPaper (id this, SEL sel, id p0, id p1)
{
	void *arg_ptrs [2];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_196, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_196, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIPrintInteractionController__UIPrintInteractionControllerDelegate_RespondsToSelector (id this, SEL sel, SEL p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
native_to_managed_trampoline_MonoTouch_GameKit_Mono_GKSessionDelegate__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_198));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_GameKit_Mono_GKSessionDelegate_PeerConnectionRequest (id this, SEL sel, id p0, NSString * p1)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_200, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = p1 ? mono_string_new (mono_domain_get (), [p1 UTF8String]) : NULL;
...
native_to_managed_trampoline_MonoTouch_GameKit_Mono_GKSessionDelegate_PeerConnectionFailed (id this, SEL sel, id p0, NSString * p1, id p2)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_201, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = p1 ? mono_string_new (mono_domain_get (), [p1 UTF8String]) : NULL;
	NSObject *nsobj2 = (NSObject *) p2;
		...
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_201, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_GameKit_Mono_GKSessionDelegate_FailedWithError (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_202, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_202, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_AddressBookUI_InternalABNewPersonViewControllerDelegate__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_205));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_AddressBookUI_InternalABUnknownPersonViewControllerDelegate__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_207));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_Foundation_NSNetService__NSNetServiceDelegate_PublishFailure (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_215, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_Foundation_NSNetService__NSNetServiceDelegate_UpdatedTxtRecordData (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_220, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
void *
native_to_managed_trampoline_MonoTouch_Foundation_NSNetService__NSNetServiceDelegate_DidAcceptConnection (id this, SEL sel, id p0, id p1, id p2)
{
	void *arg_ptrs [3];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_221, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_221, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_Foundation_NSKeyedArchiver__NSKeyedArchiverDelegate_EncodedObject (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_223, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_223, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_Foundation_NSKeyedArchiver__NSKeyedArchiverDelegate_Finished (id this, SEL sel, id p0)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_224, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_Foundation_NSKeyedArchiver__NSKeyedArchiverDelegate_WillEncode (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_225, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_225, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	void* retval = (void *) mono_runtime_invoke (method_225, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
native_to_managed_trampoline_MonoTouch_Foundation_NSKeyedArchiver__NSKeyedArchiverDelegate_Finishing (id this, SEL sel, id p0)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_226, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_Foundation_NSKeyedArchiver__NSKeyedArchiverDelegate_ReplacingObject (id this, SEL sel, id p0, id p1, id p2)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_227, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_227, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_CoreLocation_CLLocationManager__CLLocationManagerDelegate_UpdatedLocation (id this, SEL sel, id p0, id p1, id p2)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_229, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_229, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_CoreLocation_CLLocationManager__CLLocationManagerDelegate_UpdatedHeading (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_230, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_230, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_CoreLocation_CLLocationManager__CLLocationManagerDelegate_ShouldDisplayHeadingCalibration (id this, SEL sel, id p0)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		arg_ptrs [0] = mobj0;
	void* retval = (void *) mono_runtime_invoke (method_231, mthis, arg_ptrs, NULL);
	void * res;
	res = *(void * *) mono_object_unbox (retval);
	return res;
}
...
native_to_managed_trampoline_MonoTouch_CoreLocation_CLLocationManager__CLLocationManagerDelegate_Failed (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_232, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_232, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_CoreLocation_CLLocationManager__CLLocationManagerDelegate_RegionEntered (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_233, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_CoreLocation_CLLocationManager__CLLocationManagerDelegate_RegionLeft (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_234, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_CoreLocation_CLLocationManager__CLLocationManagerDelegate_MonitoringFailed (id this, SEL sel, id p0, id p1, id p2)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_235, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_235, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_235, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_CoreLocation_CLLocationManager__CLLocationManagerDelegate_DidStartMonitoringForRegion (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_236, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_CoreLocation_CLLocationManager__CLLocationManagerDelegate_DidDetermineState (id this, SEL sel, id p0, int p1, id p2)
{
	...
	NSObject *nsobj2 = (NSObject *) p2;
		...
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_237, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_CoreLocation_CLLocationManager__CLLocationManagerDelegate_DidRangeBeacons (id this, SEL sel, id p0, id p1, id p2)
{
	...
	if (p1) {
		...
		int j;
			MonoType *p_class;
		p = monotouch_get_parameter_type (method_238, 1);
		e_class = mono_class_get_element_class (mono_class_from_mono_type (p));
		marr = mono_array_new (mono_domain_get (), e_class, [arr count]);
		for (j = 0; j < [arr count]; j++) {
			NSObject *nobj = [arr objectAtIndex: j];
	...
	NSObject *nsobj2 = (NSObject *) p2;
		...
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_238, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_CoreLocation_CLLocationManager__CLLocationManagerDelegate_RangingBeaconsDidFailForRegion (id this, SEL sel, id p0, id p1, id p2)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_239, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_239, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_CoreLocation_CLLocationManager__CLLocationManagerDelegate_LocationsUpdated (id this, SEL sel, id p0, id p1)
{
	...
	if (p1) {
		...
		int j;
			MonoType *p_class;
		p = monotouch_get_parameter_type (method_241, 1);
		e_class = mono_class_get_element_class (mono_class_from_mono_type (p));
		marr = mono_array_new (mono_domain_get (), e_class, [arr count]);
		for (j = 0; j < [arr count]; j++) {
			NSObject *nobj = [arr objectAtIndex: j];
...
void *
native_to_managed_trampoline_MonoTouch_CoreImage_CIVignetteEffect__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_MonoTouch_CoreImage_CISRGBToneCurveToLinear__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_246));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_Foundation_NSKeyedUnarchiver__NSKeyedUnarchiverDelegate_DecodedObject (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_248, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	void* retval = (void *) mono_runtime_invoke (method_248, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
native_to_managed_trampoline_MonoTouch_Foundation_NSKeyedUnarchiver__NSKeyedUnarchiverDelegate_CannotDecodeClass (id this, SEL sel, id p0, NSString * p1, NSString * p2)
{
	...
	if (p2) {
		...
		int j;
			MonoType *p_class;
		p = monotouch_get_parameter_type (method_250, 2);
		e_class = mono_class_get_element_class (mono_class_from_mono_type (p));
		marr = mono_array_new (mono_domain_get (), e_class, [arr count]);
		for (j = 0; j < [arr count]; j++) {
			NSString *sv = (NSString *) [arr objectAtIndex: j];
...
native_to_managed_trampoline_MonoTouch_Foundation_NSKeyedUnarchiver__NSKeyedUnarchiverDelegate_ReplacingObject (id this, SEL sel, id p0, id p1, id p2)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_252, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_252, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIBarItem_UIBarItemAppearance__GetTitleTextAttributes (id this, SEL sel, unsigned int p0)
{
	...
	arg_ptrs [0] = &p0;
	void* retval = (void *) mono_runtime_invoke (method_254, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIRandomGenerator__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_255));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CISharpenLuminance__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_256));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_UIKit_UIDocumentInteractionController__UIDocumentInteractionControllerDelegate__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_259));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_UIKit_UIDocumentInteractionController__UIDocumentInteractionControllerDelegate_CanPerformAction (id this, SEL sel, id p0, SEL p1)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_260, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIDocumentInteractionController__UIDocumentInteractionControllerDelegate_DidDismissOpenInMenu (id this, SEL sel, id p0)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_264, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIDocumentInteractionController__UIDocumentInteractionControllerDelegate_ViewControllerForPreview (id this, SEL sel, id p0)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_268, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIDocumentInteractionController__UIDocumentInteractionControllerDelegate_ViewForPreview (id this, SEL sel, id p0)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_269, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	void* retval = (void *) mono_runtime_invoke (method_269, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
native_to_managed_trampoline_MonoTouch_UIKit_UIDocumentInteractionController__UIDocumentInteractionControllerDelegate_WillBeginPreview (id this, SEL sel, id p0)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_270, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIDocumentInteractionController__UIDocumentInteractionControllerDelegate_WillPresentOpenInMenu (id this, SEL sel, id p0)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_271, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIDocumentInteractionController__UIDocumentInteractionControllerDelegate_WillPresentOptionsMenu (id this, SEL sel, id p0)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_272, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIPerspectiveTile__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_277));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIPerspectiveTransform__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_278));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_UIKit_UIAlertView__UIAlertViewDelegate_Clicked (id this, SEL sel, id p0, int p1)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_279, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIAlertView__UIAlertViewDelegate_WillPresent (id this, SEL sel, id p0)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_281, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIAlertView__UIAlertViewDelegate_WillDismiss (id this, SEL sel, id p0, int p1)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_283, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIAlertView__UIAlertViewDelegate_ShouldEnableFirstOtherButton (id this, SEL sel, id p0)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_285, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
void *
native_to_managed_trampoline_MonoTouch_CoreImage_CILinearToSRGBToneCurve__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
native_to_managed_trampoline_MonoTouch_MapKit_MKMapView__MKMapViewDelegate_RegionChanged (id this, SEL sel, id p0, bool p1)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_289, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
...
native_to_managed_trampoline_MonoTouch_MapKit_MKMapView__MKMapViewDelegate_MapLoaded (id this, SEL sel, id p0)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_291, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_MapKit_MKMapView__MKMapViewDelegate_LoadingMapFailed (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_292, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_MapKit_MKMapView__MKMapViewDelegate_GetViewForAnnotation (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_293, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_293, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_MapKit_MKMapView__MKMapViewDelegate_DidAddAnnotationViews (id this, SEL sel, id p0, id p1)
{
	...
	if (p1) {
		...
		int j;
			MonoType *p_class;
		p = monotouch_get_parameter_type (method_294, 1);
		e_class = mono_class_get_element_class (mono_class_from_mono_type (p));
		marr = mono_array_new (mono_domain_get (), e_class, [arr count]);
		for (j = 0; j < [arr count]; j++) {
			NSObject *nobj = [arr objectAtIndex: j];
...
native_to_managed_trampoline_MonoTouch_MapKit_MKMapView__MKMapViewDelegate_CalloutAccessoryControlTapped (id this, SEL sel, id p0, id p1, id p2)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_295, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_295, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_295, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_MapKit_MKMapView__MKMapViewDelegate_ChangedDragState (id this, SEL sel, id p0, id p1, int p2, int p3)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_296, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	arg_ptrs [2] = &p2;
	arg_ptrs [3] = &p3;
...
native_to_managed_trampoline_MonoTouch_MapKit_MKMapView__MKMapViewDelegate_GetViewForOverlay (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_297, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_297, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_MapKit_MKMapView__MKMapViewDelegate_DidAddOverlayViews (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj1 = (NSObject *) p1;
		...
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_298, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_MapKit_MKMapView__MKMapViewDelegate_DidSelectAnnotationView (id this, SEL sel, id p0, id p1)
{
	...
	if (!method_299)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_299)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_299, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_299, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_MapKit_MKMapView__MKMapViewDelegate_DidFailToLocateUser (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_300, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_300, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_MapKit_MKMapView__MKMapViewDelegate_DidDeselectAnnotationView (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_301, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_301, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_MapKit_MKMapView__MKMapViewDelegate_WillStartLocatingUser (id this, SEL sel, id p0)
{
	...
	if (!method_302)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_302)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_302, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_MapKit_MKMapView__MKMapViewDelegate_DidStopLocatingUser (id this, SEL sel, id p0)
{
	...
	if (!method_303)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_303)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_303, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_MapKit_MKMapView__MKMapViewDelegate_DidUpdateUserLocation (id this, SEL sel, id p0, id p1)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_304, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_304, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	mono_runtime_invoke (method_304, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_MapKit_MKMapView__MKMapViewDelegate_DidChageUserTrackingMode (id this, SEL sel, id p0, int p1, bool p2)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_305, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	arg_ptrs [2] = &p2;
...
native_to_managed_trampoline_MonoTouch_MapKit_MKMapView__MKMapViewDelegate_DidAddOverlayRenderers (id this, SEL sel, id p0, id p1)
{
	...
	if (p1) {
		...
		int j;
			MonoType *p_class;
		p = monotouch_get_parameter_type (method_307, 1);
		e_class = mono_class_get_element_class (mono_class_from_mono_type (p));
		marr = mono_array_new (mono_domain_get (), e_class, [arr count]);
		for (j = 0; j < [arr count]; j++) {
			NSObject *nobj = [arr objectAtIndex: j];
...
native_to_managed_trampoline_MonoTouch_MapKit_MKMapView__MKMapViewDelegate_DidFinishRenderingMap (id this, SEL sel, id p0, bool p1)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_309, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
...
native_to_managed_trampoline_MonoTouch_CoreImage_CITriangleKaleidoscope__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_310));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIUnsharpMask__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_311));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_UIKit_UIActionSheet__UIActionSheetDelegate_Clicked (id this, SEL sel, id p0, int p1)
{
	...
	if (!method_312)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_312)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_312, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIActionSheet__UIActionSheetDelegate_Canceled (id this, SEL sel, id p0)
{
	...
	if (!method_313)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_313)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_313, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIActionSheet__UIActionSheetDelegate_WillPresent (id this, SEL sel, id p0)
{
	...
	if (!method_314)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_314)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_314, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIActionSheet__UIActionSheetDelegate_Presented (id this, SEL sel, id p0)
{
	...
	if (!method_315)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_315)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_315, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIActionSheet__UIActionSheetDelegate_WillDismiss (id this, SEL sel, id p0, int p1)
{
	...
	if (!method_316)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_316)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_316, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIActionSheet__UIActionSheetDelegate_Dismissed (id this, SEL sel, id p0, int p1)
{
	...
	if (!method_317)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_317)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_317, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
...
native_to_managed_trampoline_MonoTouch_MessageUI_Mono_MFMessageComposeViewControllerDelegate__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_318));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_MessageUI_Mono_MFMessageComposeViewControllerDelegate_Finished (id this, SEL sel, id p0, int p1)
{
	...
	if (!method_319)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_319)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_319, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
...
void *
native_to_managed_trampoline_MonoTouch_CoreImage_CIColorCrossPolynomial__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_320));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_UIKit_UITableViewSource__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_322));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_UIKit_UITableViewSource__ctor1 (id this, SEL sel, id p0)
{
	...
	NSObject *nsobj0 = (NSObject *) p0;
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_323, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_323));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_323, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIColorMatrix__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_324));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIColorMonochrome__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_325));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBarController__UITabBarControllerDelegate__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_326));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBarController__UITabBarControllerDelegate_ShouldSelectViewController (id this, SEL sel, id p0, id p1)
{
	...
	if (!method_327)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_327)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_327, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_327, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	void* retval = (void *) mono_runtime_invoke (method_327, mthis, arg_ptrs, NULL);
	void * res;
	res = *(void * *) mono_object_unbox (retval);
	return res;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBarController__UITabBarControllerDelegate_ViewControllerSelected (id this, SEL sel, id p0, id p1)
{
	...
	if (!method_328)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_328)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_328, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_328, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBarController__UITabBarControllerDelegate_OnCustomizingViewControllers (id this, SEL sel, id p0, id p1)
{
	...
	if (!method_329)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_329)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_329, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	if (p1) {
		NSArray *arr = (NSArray *) p1;
		...
		int j;
			MonoType *p_class;
		p = monotouch_get_parameter_type (method_329, 1);
		e_class = mono_class_get_element_class (mono_class_from_mono_type (p));
		marr = mono_array_new (mono_domain_get (), e_class, [arr count]);
		for (j = 0; j < [arr count]; j++) {
			NSObject *nobj = [arr objectAtIndex: j];
	...
	mono_runtime_invoke (method_329, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBarController__UITabBarControllerDelegate_OnEndCustomizingViewControllers (id this, SEL sel, id p0, id p1, bool p2)
{
	...
	if (!method_330)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_330)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_330, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	if (p1) {
		NSArray *arr = (NSArray *) p1;
		...
		int j;
			MonoType *p_class;
		p = monotouch_get_parameter_type (method_330, 1);
		e_class = mono_class_get_element_class (mono_class_from_mono_type (p));
		marr = mono_array_new (mono_domain_get (), e_class, [arr count]);
		for (j = 0; j < [arr count]; j++) {
			NSObject *nobj = [arr objectAtIndex: j];
	...
	arg_ptrs [2] = &p2;
	mono_runtime_invoke (method_330, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBarController__UITabBarControllerDelegate_FinishedCustomizingViewControllers (id this, SEL sel, id p0, id p1, bool p2)
{
	...
	if (!method_331)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_331)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_331, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	if (p1) {
		NSArray *arr = (NSArray *) p1;
		...
		int j;
			MonoType *p_class;
		p = monotouch_get_parameter_type (method_331, 1);
		e_class = mono_class_get_element_class (mono_class_from_mono_type (p));
		marr = mono_array_new (mono_domain_get (), e_class, [arr count]);
		for (j = 0; j < [arr count]; j++) {
			NSObject *nobj = [arr objectAtIndex: j];
	...
	arg_ptrs [2] = &p2;
	mono_runtime_invoke (method_331, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBarController__UITabBarControllerDelegate_SupportedInterfaceOrientations (id this, SEL sel, id p0)
{
	...
	if (!method_332)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_332)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_332, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBarController__UITabBarControllerDelegate_GetPreferredInterfaceOrientation (id this, SEL sel, id p0)
{
	...
	if (!method_333)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_333)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_333, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	void* retval = (void *) mono_runtime_invoke (method_333, mthis, arg_ptrs, NULL);
	void * res;
	res = *(void * *) mono_object_unbox (retval);
	return res;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBarController__UITabBarControllerDelegate_GetInteractionControllerForAnimationController (id this, SEL sel, id p0, id p1)
{
	...
	if (!method_334)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_334)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_334, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	...
	void* retval = (void *) mono_runtime_invoke (method_334, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBarController__UITabBarControllerDelegate_GetAnimationControllerForTransition (id this, SEL sel, id p0, id p1, id p2)
{
	...
	if (!method_335)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_335)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_335, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_335, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_335, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBarController__UITabBarControllerDelegate_RespondsToSelector (id this, SEL sel, SEL p0)
{
	...
	if (!method_336)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_336)));
		}
	arg_ptrs [0] = p0 ? monotouch_get_selector (p0) : NULL;
	void* retval = (void *) mono_runtime_invoke (method_336, mthis, arg_ptrs, NULL);
	void * res;
	res = *(void * *) mono_object_unbox (retval);
	return res;
}
...
native_to_managed_trampoline_MonoTouch_CoreImage_CICheckerboardGenerator__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_337));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_337, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIColorControls__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_338));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_338, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIColorCube__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_339));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
void *
native_to_managed_trampoline_MonoTouch_CoreImage_CIColorClamp__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_340));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIHueAdjust__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_342));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CILinearGradient__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_343));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_UIKit_UIScrollView__UIScrollViewDelegate_Scrolled (id this, SEL sel, id p0)
{
	...
	if (!method_345)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_345)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_345, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIScrollView__UIScrollViewDelegate_DraggingStarted (id this, SEL sel, id p0)
{
	...
	if (!method_346)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_346)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_346, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIScrollView__UIScrollViewDelegate_DraggingEnded (id this, SEL sel, id p0, bool p1)
{
	...
	if (!method_347)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_347)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_347, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIScrollView__UIScrollViewDelegate_DecelerationStarted (id this, SEL sel, id p0)
{
	...
	if (!method_348)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_348)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_348, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIScrollView__UIScrollViewDelegate_DecelerationEnded (id this, SEL sel, id p0)
{
	...
	if (!method_349)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_349)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_349, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIScrollView__UIScrollViewDelegate_ScrollAnimationEnded (id this, SEL sel, id p0)
{
	...
	if (!method_350)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_350)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_350, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIScrollView__UIScrollViewDelegate_ViewForZoomingInScrollView (id this, SEL sel, id p0)
{
	...
	if (!method_351)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_351)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_351, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIScrollView__UIScrollViewDelegate_ShouldScrollToTop (id this, SEL sel, id p0)
{
	...
	if (!method_352)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_352)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_352, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	void* retval = (void *) mono_runtime_invoke (method_352, mthis, arg_ptrs, NULL);
	void * res;
	res = *(void * *) mono_object_unbox (retval);
	return res;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UIScrollView__UIScrollViewDelegate_ScrolledToTop (id this, SEL sel, id p0)
{
	...
	if (!method_353)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_353)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_353, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIScrollView__UIScrollViewDelegate_ZoomingEnded (id this, SEL sel, id p0, id p1, float p2)
{
	...
	if (!method_354)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_354)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_354, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_354, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	arg_ptrs [2] = &p2;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIScrollView__UIScrollViewDelegate_DidZoom (id this, SEL sel, id p0)
{
	...
	if (!method_355)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_355)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_355, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIScrollView__UIScrollViewDelegate_ZoomingStarted (id this, SEL sel, id p0, id p1)
{
	...
	if (!method_356)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_356)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_356, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_356, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIScrollView__UIScrollViewDelegate_WillEndDragging (id this, SEL sel, id p0, CGPoint p1, CGPoint* p2)
{
	...
	if (!method_357)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_357)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_357, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	arg_ptrs [2] = p2;
...
void *
native_to_managed_trampoline_Xamarin_iOS_ZBar_Demo_AppDelegate__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_358));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
void *
native_to_managed_trampoline_Xamarin_iOS_ZBar_Demo_AppDelegate_FinishedLaunching (id this, SEL sel, id p0, id p1)
{
	void *arg_ptrs [2];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_359)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_359)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_359, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_359, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	void* retval = (void *) mono_runtime_invoke (method_359, mthis, arg_ptrs, NULL);
	void * res;
	res = *(void * *) mono_object_unbox (retval);
	return res;
}
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIHighlightShadowAdjust__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_360));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_360, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBar__UITabBarDelegate__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_362));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBar__UITabBarDelegate_ItemSelected (id this, SEL sel, id p0, id p1)
{
	...
	if (!method_363)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_363)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_363, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_363, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	mono_runtime_invoke (method_363, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBar__UITabBarDelegate_WillBeginCustomizingItems (id this, SEL sel, id p0, id p1)
{
	...
	if (!method_364)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_364)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_364, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	if (p1) {
		NSArray *arr = (NSArray *) p1;
		...
		int j;
			MonoType *p_class;
		p = monotouch_get_parameter_type (method_364, 1);
		e_class = mono_class_get_element_class (mono_class_from_mono_type (p));
		marr = mono_array_new (mono_domain_get (), e_class, [arr count]);
		for (j = 0; j < [arr count]; j++) {
			NSObject *nobj = [arr objectAtIndex: j];
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBar__UITabBarDelegate_DidBeginCustomizingItems (id this, SEL sel, id p0, id p1)
{
	...
	if (!method_365)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_365)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_365, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	if (p1) {
		NSArray *arr = (NSArray *) p1;
		...
		int j;
			MonoType *p_class;
		p = monotouch_get_parameter_type (method_365, 1);
		e_class = mono_class_get_element_class (mono_class_from_mono_type (p));
		marr = mono_array_new (mono_domain_get (), e_class, [arr count]);
		for (j = 0; j < [arr count]; j++) {
			NSObject *nobj = [arr objectAtIndex: j];
	...
	mono_runtime_invoke (method_365, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBar__UITabBarDelegate_WillEndCustomizingItems (id this, SEL sel, id p0, id p1, bool p2)
{
	...
	if (!method_366)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_366)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_366, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	if (p1) {
		NSArray *arr = (NSArray *) p1;
		...
		int j;
			MonoType *p_class;
		p = monotouch_get_parameter_type (method_366, 1);
		e_class = mono_class_get_element_class (mono_class_from_mono_type (p));
		marr = mono_array_new (mono_domain_get (), e_class, [arr count]);
		for (j = 0; j < [arr count]; j++) {
			NSObject *nobj = [arr objectAtIndex: j];
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBar__UITabBarDelegate_DidEndCustomizingItems (id this, SEL sel, id p0, id p1, bool p2)
{
	...
	if (!method_367)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_367)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_367, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	if (p1) {
		NSArray *arr = (NSArray *) p1;
		...
		int j;
			MonoType *p_class;
		p = monotouch_get_parameter_type (method_367, 1);
		e_class = mono_class_get_element_class (mono_class_from_mono_type (p));
		marr = mono_array_new (mono_domain_get (), e_class, [arr count]);
		for (j = 0; j < [arr count]; j++) {
			NSObject *nobj = [arr objectAtIndex: j];
	...
	arg_ptrs [2] = &p2;
	mono_runtime_invoke (method_367, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIExposureAdjust__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_368));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIGammaAdjust__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_370));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_AVFoundation_InternalAVAudioRecorderDelegate__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_372));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_AVFoundation_InternalAVAudioRecorderDelegate_FinishedRecording (id this, SEL sel, id p0, bool p1)
{
	...
	if (!method_373)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_373)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_373, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
...
native_to_managed_trampoline_MonoTouch_AVFoundation_InternalAVAudioRecorderDelegate_EncoderError (id this, SEL sel, id p0, id p1)
{
	...
	if (!method_374)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_374)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_374, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_374, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_AVFoundation_InternalAVAudioRecorderDelegate_BeginInterruption (id this, SEL sel, id p0)
{
	...
	if (!method_375)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_375)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_375, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_AVFoundation_InternalAVAudioRecorderDelegate_EndInterruption (id this, SEL sel, id p0)
{
	...
	if (!method_376)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_376)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_376, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_AVFoundation_InternalAVAudioSessionDelegate_BeginInterruption (id this, SEL sel)
{
	...
	if (!method_377)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_377)));
		}
...
native_to_managed_trampoline_MonoTouch_AVFoundation_InternalAVAudioSessionDelegate_EndInterruption (id this, SEL sel)
{
	...
	if (!method_378)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_378)));
		}
...
native_to_managed_trampoline_MonoTouch_AVFoundation_InternalAVAudioSessionDelegate_InputIsAvailableChanged (id this, SEL sel, bool p0)
{
	...
	if (!method_379)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_379)));
		}
	arg_ptrs [0] = &p0;
...
native_to_managed_trampoline_MonoTouch_CoreAnimation_CAAnimation__CAAnimationDelegate__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_380));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreAnimation_CAAnimation__CAAnimationDelegate_AnimationStarted (id this, SEL sel, id p0)
{
	...
	if (!method_381)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_381)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_381, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_CoreAnimation_CAAnimation__CAAnimationDelegate_AnimationStopped (id this, SEL sel, id p0, bool p1)
{
	...
	if (!method_382)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_382)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_382, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
...
native_to_managed_trampoline_MonoTouch_AVFoundation_InternalAVAudioPlayerDelegate_FinishedPlaying (id this, SEL sel, id p0, bool p1)
{
	...
	if (!method_384)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_384)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_384, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
...
native_to_managed_trampoline_MonoTouch_AVFoundation_InternalAVAudioPlayerDelegate_DecoderError (id this, SEL sel, id p0, id p1)
{
	...
	if (!method_385)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_385)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_385, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_385, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_AVFoundation_InternalAVAudioPlayerDelegate_BeginInterruption (id this, SEL sel, id p0)
{
	...
	if (!method_386)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_386)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_386, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_AVFoundation_InternalAVAudioPlayerDelegate_EndInterruption (id this, SEL sel, id p0)
{
	...
	if (!method_387)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_387)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_387, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UISplitViewController__UISplitViewControllerDelegate__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_388));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_UIKit_UISplitViewController__UISplitViewControllerDelegate_WillPresentViewController (id this, SEL sel, id p0, id p1, id p2)
{
	...
	if (!method_389)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_389)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_389, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_389, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_389, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_UIKit_UISplitViewController__UISplitViewControllerDelegate_WillHideViewController (id this, SEL sel, id p0, id p1, id p2, id p3)
{
	...
	if (!method_390)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_390)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_390, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_390, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_390, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
	NSObject *nsobj3 = (NSObject *) p3;
		...
		bool created3 = false;
		if (nsobj3) {
			mobj3 = get_nsobject_with_type_for_ptr_created (nsobj3, false, monotouch_get_parameter_type (method_390, 3), &created3);
		}
		arg_ptrs [3] = mobj3;
...
native_to_managed_trampoline_MonoTouch_UIKit_UISplitViewController__UISplitViewControllerDelegate_WillShowViewController (id this, SEL sel, id p0, id p1, id p2)
{
	...
	if (!method_391)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_391)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_391, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_391, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_391, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_UIKit_UISplitViewController__UISplitViewControllerDelegate_ShouldHideViewController (id this, SEL sel, id p0, id p1, int p2)
{
	...
	if (!method_392)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_392)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_392, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_392, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	arg_ptrs [2] = &p2;
	void* retval = (void *) mono_runtime_invoke (method_392, mthis, arg_ptrs, NULL);
	void * res;
	res = *(void * *) mono_object_unbox (retval);
	return res;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UIWebView__UIWebViewDelegate__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_393));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_UIKit_UIWebView__UIWebViewDelegate_ShouldStartLoad (id this, SEL sel, id p0, id p1, int p2)
{
	...
	if (!method_394)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_394)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_394, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_394, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	arg_ptrs [2] = &p2;
	void* retval = (void *) mono_runtime_invoke (method_394, mthis, arg_ptrs, NULL);
	void * res;
	res = *(void * *) mono_object_unbox (retval);
	return res;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UIWebView__UIWebViewDelegate_LoadStarted (id this, SEL sel, id p0)
{
	...
	if (!method_395)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_395)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_395, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_395, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UIWebView__UIWebViewDelegate_LoadingFinished (id this, SEL sel, id p0)
{
	...
	if (!method_396)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_396)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_396, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_396, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UIWebView__UIWebViewDelegate_LoadFailed (id this, SEL sel, id p0, id p1)
{
	...
	if (!method_397)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_397)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_397, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_397, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBPeripheral__CBPeripheralDelegate__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_398));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBPeripheral__CBPeripheralDelegate_RssiUpdated (id this, SEL sel, id p0, id p1)
{
	...
	if (!method_399)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_399)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_399, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_399, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	mono_runtime_invoke (method_399, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBPeripheral__CBPeripheralDelegate_DiscoveredService (id this, SEL sel, id p0, id p1)
{
	...
	if (!method_400)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_400)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_400, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_400, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBPeripheral__CBPeripheralDelegate_DiscoveredIncludedService (id this, SEL sel, id p0, id p1, id p2)
{
	...
	if (!method_401)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_401)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_401, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_401, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_401, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBPeripheral__CBPeripheralDelegate_DiscoverCharacteristic (id this, SEL sel, id p0, id p1, id p2)
{
	...
	if (!method_402)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_402)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_402, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_402, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_402, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBPeripheral__CBPeripheralDelegate_UpdatedCharacterteristicValue (id this, SEL sel, id p0, id p1, id p2)
{
	...
	if (!method_403)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_403)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_403, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_403, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_403, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBPeripheral__CBPeripheralDelegate_WroteCharacteristicValue (id this, SEL sel, id p0, id p1, id p2)
{
	...
	if (!method_404)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_404)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_404, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_404, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_404, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBPeripheral__CBPeripheralDelegate_UpdatedNotificationState (id this, SEL sel, id p0, id p1, id p2)
{
	...
	if (!method_405)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_405)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_405, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_405, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_405, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBPeripheral__CBPeripheralDelegate_DiscoveredDescriptor (id this, SEL sel, id p0, id p1, id p2)
{
	...
	if (!method_406)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_406)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_406, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_406, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_406, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBPeripheral__CBPeripheralDelegate_UpdatedValue (id this, SEL sel, id p0, id p1, id p2)
{
	...
	if (!method_407)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_407)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_407, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_407, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_407, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBPeripheral__CBPeripheralDelegate_WroteDescriptorValue (id this, SEL sel, id p0, id p1, id p2)
{
	...
	if (!method_408)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_408)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_408, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_408, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_408, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
	mono_runtime_invoke (method_408, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBPeripheral__CBPeripheralDelegate_InvalidatedService (id this, SEL sel, id p0)
{
	...
	if (!method_409)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_409)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_409, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_409, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBPeripheral__CBPeripheralDelegate_UpdatedName (id this, SEL sel, id p0)
{
	...
	if (!method_410)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_410)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_410, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
void *
native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBPeripheral__CBPeripheralDelegate_ModifiedServices (id this, SEL sel, id p0, id p1)
{
	void *arg_ptrs [2];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_411)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_411)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_411, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	if (p1) {
		NSArray *arr = (NSArray *) p1;
		...
		int j;
			MonoType *p_class;
		p = monotouch_get_parameter_type (method_411, 1);
		e_class = mono_class_get_element_class (mono_class_from_mono_type (p));
		marr = mono_array_new (mono_domain_get (), e_class, [arr count]);
		for (j = 0; j < [arr count]; j++) {
			NSObject *nobj = [arr objectAtIndex: j];
...
native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBCentralManager__CBCentralManagerDelegate__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_412));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBCentralManager__CBCentralManagerDelegate_UpdatedState (id this, SEL sel, id p0)
{
	...
	if (!method_413)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_413)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_413, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBCentralManager__CBCentralManagerDelegate_RetrievedPeripherals (id this, SEL sel, id p0, id p1)
{
	...
	if (!method_414)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_414)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_414, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	if (p1) {
		NSArray *arr = (NSArray *) p1;
		...
		int j;
			MonoType *p_class;
		p = monotouch_get_parameter_type (method_414, 1);
		e_class = mono_class_get_element_class (mono_class_from_mono_type (p));
		marr = mono_array_new (mono_domain_get (), e_class, [arr count]);
		for (j = 0; j < [arr count]; j++) {
			NSObject *nobj = [arr objectAtIndex: j];
...
native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBCentralManager__CBCentralManagerDelegate_RetrievedConnectedPeripherals (id this, SEL sel, id p0, id p1)
{
	...
	if (!method_415)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_415)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_415, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	if (p1) {
		NSArray *arr = (NSArray *) p1;
		...
		int j;
			MonoType *p_class;
		p = monotouch_get_parameter_type (method_415, 1);
		e_class = mono_class_get_element_class (mono_class_from_mono_type (p));
		marr = mono_array_new (mono_domain_get (), e_class, [arr count]);
		for (j = 0; j < [arr count]; j++) {
			NSObject *nobj = [arr objectAtIndex: j];
	...
	mono_runtime_invoke (method_415, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBCentralManager__CBCentralManagerDelegate_DiscoveredPeripheral (id this, SEL sel, id p0, id p1, id p2, id p3)
{
	...
	if (!method_416)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_416)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_416, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_416, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_416, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
	NSObject *nsobj3 = (NSObject *) p3;
		MonoObject *mobj3 = NULL;
		bool created3 = false;
		if (nsobj3) {
			mobj3 = get_nsobject_with_type_for_ptr_created (nsobj3, false, monotouch_get_parameter_type (method_416, 3), &created3);
		}
		arg_ptrs [3] = mobj3;
...
native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBCentralManager__CBCentralManagerDelegate_ConnectedPeripheral (id this, SEL sel, id p0, id p1)
{
	...
	if (!method_417)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_417)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_417, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_417, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	mono_runtime_invoke (method_417, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBCentralManager__CBCentralManagerDelegate_FailedToConnectPeripheral (id this, SEL sel, id p0, id p1, id p2)
{
	...
	if (!method_418)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_418)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_418, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_418, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_418, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBCentralManager__CBCentralManagerDelegate_DisconnectedPeripheral (id this, SEL sel, id p0, id p1, id p2)
{
	...
	if (!method_419)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_419)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_419, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_419, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_419, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
	mono_runtime_invoke (method_419, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_420 = NULL;
void *
native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBCentralManager__CBCentralManagerDelegate_WillRestoreState (id this, SEL sel, id p0, id p1)
{
	void *arg_ptrs [2];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_420)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_420)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_420, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_420, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIQRCodeGenerator__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_421));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_421, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UICollisionBehavior__UICollisionBehaviorDelegate__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_422));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UICollisionBehavior__UICollisionBehaviorDelegate_BeganContact (id this, SEL sel, id p0, id p1, id p2, CGPoint p3)
{
	void *arg_ptrs [4];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_423)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_423)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_423, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = monotouch_get_inative_object_static (p1, false, "MonoTouch.UIKit.UIDynamicItemWrapper, monotouch", "MonoTouch.UIKit.IUIDynamicItem, monotouch");
	arg_ptrs [2] = monotouch_get_inative_object_static (p2, false, "MonoTouch.UIKit.UIDynamicItemWrapper, monotouch", "MonoTouch.UIKit.IUIDynamicItem, monotouch");
	arg_ptrs [3] = &p3;
	mono_runtime_invoke (method_423, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_424 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UICollisionBehavior__UICollisionBehaviorDelegate_EndedContact (id this, SEL sel, id p0, id p1, id p2)
{
	void *arg_ptrs [3];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_424)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_424)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_424, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = monotouch_get_inative_object_static (p1, false, "MonoTouch.UIKit.UIDynamicItemWrapper, monotouch", "MonoTouch.UIKit.IUIDynamicItem, monotouch");
	arg_ptrs [2] = monotouch_get_inative_object_static (p2, false, "MonoTouch.UIKit.UIDynamicItemWrapper, monotouch", "MonoTouch.UIKit.IUIDynamicItem, monotouch");
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UICollisionBehavior__UICollisionBehaviorDelegate_BeganBoundaryContact (id this, SEL sel, id p0, id p1, id p2, CGPoint p3)
{
	void *arg_ptrs [4];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_425)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_425)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_425, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = monotouch_get_inative_object_static (p1, false, "MonoTouch.UIKit.UIDynamicItemWrapper, monotouch", "MonoTouch.UIKit.IUIDynamicItem, monotouch");
	NSObject *nsobj2 = (NSObject *) p2;
		...
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_425, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
	arg_ptrs [3] = &p3;
	mono_runtime_invoke (method_425, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_426 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UICollisionBehavior__UICollisionBehaviorDelegate_EndedBoundaryContact (id this, SEL sel, id p0, id p1, id p2)
{
	void *arg_ptrs [3];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_426)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_426)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_426, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = monotouch_get_inative_object_static (p1, false, "MonoTouch.UIKit.UIDynamicItemWrapper, monotouch", "MonoTouch.UIKit.IUIDynamicItem, monotouch");
	NSObject *nsobj2 = (NSObject *) p2;
		...
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_426, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIAccelerometer__UIAccelerometerDelegate__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_427));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_427, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIAccelerometer__UIAccelerometerDelegate_DidAccelerate (id this, SEL sel, id p0, id p1)
{
	...
	if (!method_428)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_428)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_428, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_428, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
void *
native_to_managed_trampoline_MonoTouch_CoreImage_CIPhotoEffectMono__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_429));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_429, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
void *
native_to_managed_trampoline_MonoTouch_CoreImage_CIPhotoEffectNoir__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_430));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIMaximumCompositing__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_431));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
void *
native_to_managed_trampoline_MonoTouch_CoreImage_CIPhotoEffectProcess__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_432));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_432, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
void *
native_to_managed_trampoline_MonoTouch_CoreImage_CIPhotoEffectTonal__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_433));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIMinimumCompositing__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_434));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_434, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
native_to_managed_trampoline_MonoTouch_CoreImage_CICopyMachineTransition__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_435));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIMultiplyBlendMode__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_436));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_436, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIOverlayBlendMode__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_437));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
void *
native_to_managed_trampoline_MonoTouch_CoreImage_CIPhotoEffectFade__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_438));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_438, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
native_to_managed_trampoline_MonoTouch_CoreImage_CISaturationBlendMode__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_439));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIScreenBlendMode__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_440));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_440, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIAdditionCompositing__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_442));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIBarsSwipeTransition__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_443));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
void *
native_to_managed_trampoline_MonoTouch_CoreImage_CIPhotoEffectInstant__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_444));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIPinchDistortion__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_445));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CISwipeTransition__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_446));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CITwirlDistortion__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_447));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_447, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIVortexDistortion__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_448));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
void *
native_to_managed_trampoline_Xamarin_iOS_ZBar_Demo_ZBarDemoViewController_get_BarcodeResultLabel (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_449)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_449)));
		}
	void* retval = (void *) mono_runtime_invoke (method_449, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
void *
native_to_managed_trampoline_Xamarin_iOS_ZBar_Demo_ZBarDemoViewController_set_BarcodeResultLabel (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_450)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_450)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_450, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_450, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_451 = NULL;
void *
native_to_managed_trampoline_Xamarin_iOS_ZBar_Demo_ZBarDemoViewController_get_ScanButton (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_451)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_451)));
		}
...
void *
native_to_managed_trampoline_Xamarin_iOS_ZBar_Demo_ZBarDemoViewController_set_ScanButton (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_452)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_452)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_452, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
void *
native_to_managed_trampoline_Xamarin_iOS_ZBar_Demo_ZBarDemoViewController__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
...
void *
native_to_managed_trampoline_Xamarin_iOS_ZBar_Demo_ZBarDemoViewController_ViewDidLoad (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_454)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_454)));
		}
...
void *
native_to_managed_trampoline_MonoTouch_CoreImage_CIPhotoEffectTransfer__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_455));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIModTransition__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_456));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIMultiplyCompositing__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_457));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CISourceAtopCompositing__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_458));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CISourceOverCompositing__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_461));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_461, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIDisintegrateWithMaskTransition__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_462));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_StoreKit_SKProductsRequest__SKProductsRequestDelegate__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_463));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_StoreKit_SKProductsRequest__SKProductsRequestDelegate_ReceivedResponse (id this, SEL sel, id p0, id p1)
{
	...
	if (!method_464)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_464)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_464, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_464, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	mono_runtime_invoke (method_464, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_StoreKit_SKProductsRequest__SKProductsRequestDelegate_RequestFinished (id this, SEL sel, id p0)
{
	...
	if (!method_465)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_465)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_465, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_StoreKit_SKProductsRequest__SKProductsRequestDelegate_RequestFailed (id this, SEL sel, id p0, id p1)
{
	...
	if (!method_466)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_466)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_466, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_466, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	mono_runtime_invoke (method_466, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIDissolveTransition__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_467));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_467, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIFlashTransition__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_468));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
void *
native_to_managed_trampoline_MonoTouch_CoreImage_CIPhotoEffectChrome__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_469));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_469, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIGlideReflectedTile__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_470));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIFourfoldTranslatedTile__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_471));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_471, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIDarkenBlendMode__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_472));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIFourfoldRotatedTile__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_473));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIFourfoldReflectedTile__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_474));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_474, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIEightfoldReflectedTile__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_475));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIDifferenceBlendMode__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_476));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_476, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIExclusionBlendMode__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_477));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIHardLightBlendMode__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_478));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_478, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
native_to_managed_trampoline_MonoTouch_CoreImage_CISixfoldReflectedTile__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_479));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CICircleSplashDistortion__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_480));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_480, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIBlendWithMask__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_481));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIColorBlendMode__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_482));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_482, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIColorBurnBlendMode__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_483));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIColorDodgeBlendMode__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_484));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_484, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
native_to_managed_trampoline_MonoTouch_CoreImage_CITwelvefoldReflectedTile__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_485));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CISixfoldRotatedTile__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_486));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_486, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIAffineTile__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_488));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIHoleDistortion__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_489));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_489, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
void *
native_to_managed_trampoline_MonoTouch_CoreImage_CIConvolution5X5__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_490));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
void *
native_to_managed_trampoline_MonoTouch_CoreImage_CIConvolution9Horizontal__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_491));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_491, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
void *
native_to_managed_trampoline_MonoTouch_CoreImage_CIConvolution9Vertical__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_492));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIAffineClamp__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_493));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_493, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
void *
native_to_managed_trampoline_MonoTouch_CoreImage_CIPerspectiveTransformWithExtent__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_494));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CILuminosityBlendMode__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_495));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
void *
native_to_managed_trampoline_MonoTouch_CoreImage_CIColorPolynomial__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_496));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_496, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
native_to_managed_trampoline_MonoTouch_CoreImage_CILineScreen__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_497));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIHatchedScreen__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_498));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_498, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
void *
native_to_managed_trampoline_MonoTouch_CoreImage_CIBumpDistortion__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_499));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_499, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIDotScreen__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_500));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
void *
native_to_managed_trampoline_MonoTouch_CoreImage_CIBumpDistortionLinear__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_501));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_501, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
native_to_managed_trampoline_MonoTouch_CoreImage_CIAffineTransform__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_502));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CICircularScreen__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_503));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_503, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
void *
native_to_managed_trampoline_MonoTouch_CoreImage_CIColorCubeWithColorSpace__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_504));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_CoreImage_CILightenBlendMode__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_505));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_505, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
void *
native_to_managed_trampoline_MonoTouch_CoreImage_CIConvolution3X3__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_506));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_UIKit_UIActivityIndicatorView_UIActivityIndicatorViewAppearance_get_Color (id this, SEL sel)
{
	...
	if (!method_507)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_507)));
		}
...
native_to_managed_trampoline_MonoTouch_UIKit_UIActivityIndicatorView_UIActivityIndicatorViewAppearance_set_Color (id this, SEL sel, id p0)
{
	...
	if (!method_508)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_508)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_508, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIToolbar_UIToolbarAppearance_get_BarTintColor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_509)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_509)));
		}
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIToolbar_UIToolbarAppearance_set_BarTintColor (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_510)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_510)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		nsobj0 = [nsobj0 copy];
		[nsobj0 autorelease];
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_510, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIToolbar_UIToolbarAppearance_SetBackgroundImage (id this, SEL sel, id p0, int p1, int p2)
{
	...
	if (!method_511)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_511)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_511, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	arg_ptrs [2] = &p2;
	mono_runtime_invoke (method_511, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UIToolbar_UIToolbarAppearance_GetBackgroundImage (id this, SEL sel, int p0, int p1)
{
	...
	if (!method_512)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_512)));
		}
	arg_ptrs [0] = &p0;
	arg_ptrs [1] = &p1;
	void* retval = (void *) mono_runtime_invoke (method_512, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
native_to_managed_trampoline_MonoTouch_UIKit_UIToolbar_UIToolbarAppearance_SetShadowImage (id this, SEL sel, id p0, int p1)
{
	...
	if (!method_513)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_513)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_513, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	mono_runtime_invoke (method_513, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UIToolbar_UIToolbarAppearance_GetShadowImage (id this, SEL sel, int p0)
{
	...
	if (!method_514)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_514)));
		}
	arg_ptrs [0] = &p0;
	void* retval = (void *) mono_runtime_invoke (method_514, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBarItem_UITabBarItemAppearance_get_TitlePositionAdjustment (void *buffer, id this, SEL sel)
{
	...
	if (!method_515)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_515)));
		}
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBarItem_UITabBarItemAppearance_set_TitlePositionAdjustment (id this, SEL sel, UIOffset p0)
{
	...
	if (!method_516)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_516)));
		}
	arg_ptrs [0] = &p0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIProgressView_UIProgressViewAppearance_get_ProgressTintColor (id this, SEL sel)
{
	...
	if (!method_517)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_517)));
		}
	void* retval = (void *) mono_runtime_invoke (method_517, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
native_to_managed_trampoline_MonoTouch_UIKit_UIProgressView_UIProgressViewAppearance_set_ProgressTintColor (id this, SEL sel, id p0)
{
	...
	if (!method_518)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_518)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_518, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIProgressView_UIProgressViewAppearance_get_TrackTintColor (id this, SEL sel)
{
	...
	if (!method_519)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_519)));
		}
	void* retval = (void *) mono_runtime_invoke (method_519, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
native_to_managed_trampoline_MonoTouch_UIKit_UIProgressView_UIProgressViewAppearance_set_TrackTintColor (id this, SEL sel, id p0)
{
	...
	if (!method_520)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_520)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_520, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIProgressView_UIProgressViewAppearance_get_ProgressImage (id this, SEL sel)
{
	...
	if (!method_521)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_521)));
		}
	void* retval = (void *) mono_runtime_invoke (method_521, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
native_to_managed_trampoline_MonoTouch_UIKit_UIProgressView_UIProgressViewAppearance_set_ProgressImage (id this, SEL sel, id p0)
{
	...
	if (!method_522)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_522)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_522, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIProgressView_UIProgressViewAppearance_get_TrackImage (id this, SEL sel)
{
	...
	if (!method_523)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_523)));
		}
	void* retval = (void *) mono_runtime_invoke (method_523, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
native_to_managed_trampoline_MonoTouch_UIKit_UIProgressView_UIProgressViewAppearance_set_TrackImage (id this, SEL sel, id p0)
{
	...
	if (!method_524)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_524)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_524, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UILabel_UILabelAppearance_get_Font (id this, SEL sel)
{
	...
	if (!method_525)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_525)));
		}
	void* retval = (void *) mono_runtime_invoke (method_525, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
native_to_managed_trampoline_MonoTouch_UIKit_UILabel_UILabelAppearance_set_Font (id this, SEL sel, id p0)
{
	...
	if (!method_526)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_526)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_526, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UILabel_UILabelAppearance_get_TextColor (id this, SEL sel)
{
	...
	if (!method_527)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_527)));
		}
	void* retval = (void *) mono_runtime_invoke (method_527, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
native_to_managed_trampoline_MonoTouch_UIKit_UILabel_UILabelAppearance_set_TextColor (id this, SEL sel, id p0)
{
	...
	if (!method_528)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_528)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_528, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UILabel_UILabelAppearance_get_ShadowColor (id this, SEL sel)
{
	...
	if (!method_529)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_529)));
		}
	void* retval = (void *) mono_runtime_invoke (method_529, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
native_to_managed_trampoline_MonoTouch_UIKit_UILabel_UILabelAppearance_set_ShadowColor (id this, SEL sel, id p0)
{
	...
	if (!method_530)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_530)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_530, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UILabel_UILabelAppearance_get_ShadowOffset (void *buffer, id this, SEL sel)
{
	...
	if (!method_531)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_531)));
		}
	void* retval = (void *) mono_runtime_invoke (method_531, mthis, arg_ptrs, NULL);
	memcpy (buffer, mono_object_unbox (retval), 8);
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UILabel_UILabelAppearance_set_ShadowOffset (id this, SEL sel, CGSize p0)
{
	...
	if (!method_532)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_532)));
		}
	arg_ptrs [0] = &p0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UILabel_UILabelAppearance_get_HighlightedTextColor (id this, SEL sel)
{
	...
	if (!method_533)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_533)));
		}
...
native_to_managed_trampoline_MonoTouch_UIKit_UILabel_UILabelAppearance_set_HighlightedTextColor (id this, SEL sel, id p0)
{
	...
	if (!method_534)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_534)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_534, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIVideoEditorController__UIVideoEditorControllerDelegate_VideoSaved (id this, SEL sel, id p0, NSString * p1)
{
	...
	if (!method_536)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_536)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_536, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = p1 ? mono_string_new (mono_domain_get (), [p1 UTF8String]) : NULL;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIVideoEditorController__UIVideoEditorControllerDelegate_Failed (id this, SEL sel, id p0, id p1)
{
	...
	if (!method_537)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_537)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_537, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_537, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIVideoEditorController__UIVideoEditorControllerDelegate_UserCancelled (id this, SEL sel, id p0)
{
	...
	if (!method_538)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_538)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_538, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIVideoEditorController__UIVideoEditorControllerDelegate_WillShowViewController (id this, SEL sel, id p0, id p1, bool p2)
{
	...
	if (!method_539)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_539)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_539, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_539, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	arg_ptrs [2] = &p2;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIVideoEditorController__UIVideoEditorControllerDelegate_DidShowViewController (id this, SEL sel, id p0, id p1, bool p2)
{
	...
	if (!method_540)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_540)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_540, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_540, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	arg_ptrs [2] = &p2;
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIVideoEditorController__UIVideoEditorControllerDelegate_SupportedInterfaceOrientations (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_541)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_541)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_541, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	void* retval = (void *) mono_runtime_invoke (method_541, mthis, arg_ptrs, NULL);
	void * res;
	res = *(void * *) mono_object_unbox (retval);
	return res;
}
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIVideoEditorController__UIVideoEditorControllerDelegate_GetPreferredInterfaceOrientation (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_542)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_542)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_542, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	void* retval = (void *) mono_runtime_invoke (method_542, mthis, arg_ptrs, NULL);
	void * res;
	res = *(void * *) mono_object_unbox (retval);
	return res;
}
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIVideoEditorController__UIVideoEditorControllerDelegate_GetInteractionControllerForAnimationController (id this, SEL sel, id p0, id p1)
{
	void *arg_ptrs [2];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_543)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_543)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_543, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = monotouch_get_inative_object_static (p1, false, "MonoTouch.UIKit.UIViewControllerAnimatedTransitioningWrapper, monotouch", "MonoTouch.UIKit.IUIViewControllerAnimatedTransitioning, monotouch");
	void* retval = (void *) mono_runtime_invoke (method_543, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIVideoEditorController__UIVideoEditorControllerDelegate_GetAnimationControllerForOperation (id this, SEL sel, id p0, int p1, id p2, id p3)
{
	void *arg_ptrs [4];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_544)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_544)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_544, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	NSObject *nsobj2 = (NSObject *) p2;
		...
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_544, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
	NSObject *nsobj3 = (NSObject *) p3;
		MonoObject *mobj3 = NULL;
		bool created3 = false;
		if (nsobj3) {
			mobj3 = get_nsobject_with_type_for_ptr_created (nsobj3, false, monotouch_get_parameter_type (method_544, 3), &created3);
		}
		arg_ptrs [3] = mobj3;
	void* retval = (void *) mono_runtime_invoke (method_544, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIVideoEditorController__UIVideoEditorControllerDelegate_RespondsToSelector (id this, SEL sel, SEL p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_545)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_545)));
		}
	arg_ptrs [0] = p0 ? monotouch_get_selector (p0) : NULL;
	void* retval = (void *) mono_runtime_invoke (method_545, mthis, arg_ptrs, NULL);
	void * res;
	res = *(void * *) mono_object_unbox (retval);
	return res;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_ShouldBeginEditing (id this, SEL sel, id p0)
{
	...
	if (!method_547)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_547)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_547, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	void* retval = (void *) mono_runtime_invoke (method_547, mthis, arg_ptrs, NULL);
	void * res;
	res = *(void * *) mono_object_unbox (retval);
	return res;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_ShouldEndEditing (id this, SEL sel, id p0)
{
	...
	if (!method_548)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_548)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_548, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	void* retval = (void *) mono_runtime_invoke (method_548, mthis, arg_ptrs, NULL);
	void * res;
	res = *(void * *) mono_object_unbox (retval);
	return res;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_EditingStarted (id this, SEL sel, id p0)
{
	...
	if (!method_549)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_549)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_549, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_EditingEnded (id this, SEL sel, id p0)
{
	...
	if (!method_550)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_550)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_550, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_ShouldChangeText (id this, SEL sel, id p0, NSRange p1, NSString * p2)
{
	...
	if (!method_551)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_551)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_551, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	arg_ptrs [2] = p2 ? mono_string_new (mono_domain_get (), [p2 UTF8String]) : NULL;
	void* retval = (void *) mono_runtime_invoke (method_551, mthis, arg_ptrs, NULL);
	void * res;
	res = *(void * *) mono_object_unbox (retval);
	return res;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_Changed (id this, SEL sel, id p0)
{
	...
	if (!method_552)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_552)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_552, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_SelectionChanged (id this, SEL sel, id p0)
{
	...
	if (!method_553)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_553)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_553, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_ShouldInteractWithUrl (id this, SEL sel, id p0, id p1, NSRange p2)
{
	...
	if (!method_554)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_554)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_554, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_554, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	arg_ptrs [2] = &p2;
	void* retval = (void *) mono_runtime_invoke (method_554, mthis, arg_ptrs, NULL);
	void * res;
	res = *(void * *) mono_object_unbox (retval);
	return res;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_ShouldInteractWithTextAttachment (id this, SEL sel, id p0, id p1, NSRange p2)
{
	...
	if (!method_555)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_555)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_555, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_555, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	arg_ptrs [2] = &p2;
	void* retval = (void *) mono_runtime_invoke (method_555, mthis, arg_ptrs, NULL);
	void * res;
	res = *(void * *) mono_object_unbox (retval);
	return res;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_Scrolled (id this, SEL sel, id p0)
{
	...
	if (!method_556)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_556)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_556, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_DraggingStarted (id this, SEL sel, id p0)
{
	...
	if (!method_557)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_557)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_557, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_DraggingEnded (id this, SEL sel, id p0, bool p1)
{
	...
	if (!method_558)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_558)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_558, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_DecelerationStarted (id this, SEL sel, id p0)
{
	...
	if (!method_559)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_559)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_559, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_DecelerationEnded (id this, SEL sel, id p0)
{
	...
	if (!method_560)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_560)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_560, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_ScrollAnimationEnded (id this, SEL sel, id p0)
{
	...
	if (!method_561)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_561)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_561, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_ViewForZoomingInScrollView (id this, SEL sel, id p0)
{
	...
	if (!method_562)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_562)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_562, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	void* retval = (void *) mono_runtime_invoke (method_562, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_ShouldScrollToTop (id this, SEL sel, id p0)
{
	...
	if (!method_563)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_563)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_563, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	void* retval = (void *) mono_runtime_invoke (method_563, mthis, arg_ptrs, NULL);
	void * res;
	res = *(void * *) mono_object_unbox (retval);
	return res;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_ScrolledToTop (id this, SEL sel, id p0)
{
	...
	if (!method_564)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_564)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_564, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_ZoomingEnded (id this, SEL sel, id p0, id p1, float p2)
{
	...
	if (!method_565)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_565)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_565, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_565, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	arg_ptrs [2] = &p2;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_DidZoom (id this, SEL sel, id p0)
{
	...
	if (!method_566)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_566)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_566, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_ZoomingStarted (id this, SEL sel, id p0, id p1)
{
	...
	if (!method_567)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_567)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_567, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_567, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITextView__UITextViewDelegate_WillEndDragging (id this, SEL sel, id p0, CGPoint p1, CGPoint* p2)
{
	...
	if (!method_568)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_568)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_568, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	arg_ptrs [2] = p2;
...
native_to_managed_trampoline_MonoTouch_MessageUI_Mono_MFMailComposeViewControllerDelegate_Finished (id this, SEL sel, id p0, int p1, id p2)
{
	...
	if (!method_570)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_570)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_570, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	NSObject *nsobj2 = (NSObject *) p2;
		...
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_570, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIBarButtonItem_UIBarButtonItemAppearance_get_TintColor (id this, SEL sel)
{
	...
	if (!method_571)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_571)));
		}
	void* retval = (void *) mono_runtime_invoke (method_571, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
native_to_managed_trampoline_MonoTouch_UIKit_UIBarButtonItem_UIBarButtonItemAppearance_set_TintColor (id this, SEL sel, id p0)
{
	...
	if (!method_572)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_572)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_572, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIBarButtonItem_UIBarButtonItemAppearance_SetBackgroundImage (id this, SEL sel, id p0, unsigned int p1, int p2)
{
	...
	if (!method_573)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_573)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_573, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	arg_ptrs [2] = &p2;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIBarButtonItem_UIBarButtonItemAppearance_GetBackgroundImage (id this, SEL sel, unsigned int p0, int p1)
{
	...
	if (!method_574)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_574)));
		}
	arg_ptrs [0] = &p0;
	arg_ptrs [1] = &p1;
	void* retval = (void *) mono_runtime_invoke (method_574, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
native_to_managed_trampoline_MonoTouch_UIKit_UIBarButtonItem_UIBarButtonItemAppearance_SetBackgroundVerticalPositionAdjustment (id this, SEL sel, float p0, int p1)
{
	...
	if (!method_575)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_575)));
		}
	arg_ptrs [0] = &p0;
	arg_ptrs [1] = &p1;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIBarButtonItem_UIBarButtonItemAppearance_GetBackgroundVerticalPositionAdjustment (id this, SEL sel, int p0)
{
	...
	if (!method_576)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_576)));
		}
	arg_ptrs [0] = &p0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIBarButtonItem_UIBarButtonItemAppearance_SetTitlePositionAdjustment (id this, SEL sel, UIOffset p0, int p1)
{
	...
	if (!method_577)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_577)));
		}
	arg_ptrs [0] = &p0;
	arg_ptrs [1] = &p1;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIBarButtonItem_UIBarButtonItemAppearance_GetTitlePositionAdjustment (void *buffer, id this, SEL sel, int p0)
{
	...
	if (!method_578)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_578)));
		}
	arg_ptrs [0] = &p0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIBarButtonItem_UIBarButtonItemAppearance_SetBackButtonBackgroundImage (id this, SEL sel, id p0, unsigned int p1, int p2)
{
	...
	if (!method_579)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_579)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_579, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	arg_ptrs [2] = &p2;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIBarButtonItem_UIBarButtonItemAppearance_GetBackButtonBackgroundImage (id this, SEL sel, unsigned int p0, int p1)
{
	...
	if (!method_580)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_580)));
		}
	arg_ptrs [0] = &p0;
	arg_ptrs [1] = &p1;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIBarButtonItem_UIBarButtonItemAppearance_SetBackButtonTitlePositionAdjustment (id this, SEL sel, UIOffset p0, int p1)
{
	...
	if (!method_581)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_581)));
		}
	arg_ptrs [0] = &p0;
	arg_ptrs [1] = &p1;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIBarButtonItem_UIBarButtonItemAppearance_GetBackButtonTitlePositionAdjustment (void *buffer, id this, SEL sel, int p0)
{
	...
	if (!method_582)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_582)));
		}
	arg_ptrs [0] = &p0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIBarButtonItem_UIBarButtonItemAppearance_SetBackButtonBackgroundVerticalPositionAdjustment (id this, SEL sel, float p0, int p1)
{
	...
	if (!method_583)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_583)));
		}
	arg_ptrs [0] = &p0;
	arg_ptrs [1] = &p1;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIBarButtonItem_UIBarButtonItemAppearance_GetBackButtonBackgroundVerticalPositionAdjustment (id this, SEL sel, int p0)
{
	...
	if (!method_584)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_584)));
		}
	arg_ptrs [0] = &p0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIBarButtonItem_UIBarButtonItemAppearance_SetBackgroundImage1 (id this, SEL sel, id p0, unsigned int p1, int p2, int p3)
{
	...
	if (!method_585)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_585)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_585, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	arg_ptrs [2] = &p2;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIBarButtonItem_UIBarButtonItemAppearance_GetBackgroundImage1 (id this, SEL sel, unsigned int p0, int p1, int p2)
{
	...
	if (!method_586)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_586)));
		}
	arg_ptrs [0] = &p0;
	arg_ptrs [1] = &p1;
	arg_ptrs [2] = &p2;
	void* retval = (void *) mono_runtime_invoke (method_586, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
void *
native_to_managed_trampoline_MonoTouch_CoreImage_CISmoothLinearGradient__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_587));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_587, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
native_to_managed_trampoline_MonoTouch_AddressBookUI_InternalABPeoplePickerNavigationControllerDelegate__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_588));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_AddressBookUI_InternalABPeoplePickerNavigationControllerDelegate_ShouldContinue (id this, SEL sel, id p0, void * p1)
{
	...
	if (!method_589)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_589)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_589, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	void * a1 = p1;
	arg_ptrs [1] = &a1;
...
native_to_managed_trampoline_MonoTouch_AddressBookUI_InternalABPeoplePickerNavigationControllerDelegate_ShouldContinue1 (id this, SEL sel, id p0, void * p1, int p2, int p3)
{
	...
	if (!method_590)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_590)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_590, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	void * a1 = p1;
	arg_ptrs [1] = &a1;
	arg_ptrs [2] = &p2;
	arg_ptrs [3] = &p3;
	void* retval = (void *) mono_runtime_invoke (method_590, mthis, arg_ptrs, NULL);
	void * res;
	res = *(void * *) mono_object_unbox (retval);
	return res;
}
...
native_to_managed_trampoline_MonoTouch_AddressBookUI_InternalABPeoplePickerNavigationControllerDelegate_Cancelled (id this, SEL sel, id p0)
{
	...
	if (!method_591)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_591)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_591, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_591, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar__UISearchBarDelegate__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_592));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar__UISearchBarDelegate_ShouldBeginEditing (id this, SEL sel, id p0)
{
	...
	if (!method_593)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_593)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_593, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar__UISearchBarDelegate_OnEditingStarted (id this, SEL sel, id p0)
{
	...
	if (!method_594)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_594)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_594, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_594, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar__UISearchBarDelegate_ShouldEndEditing (id this, SEL sel, id p0)
{
	...
	if (!method_595)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_595)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_595, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	void* retval = (void *) mono_runtime_invoke (method_595, mthis, arg_ptrs, NULL);
	void * res;
	res = *(void * *) mono_object_unbox (retval);
	return res;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar__UISearchBarDelegate_OnEditingStopped (id this, SEL sel, id p0)
{
	...
	if (!method_596)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_596)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_596, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar__UISearchBarDelegate_TextChanged (id this, SEL sel, id p0, NSString * p1)
{
	...
	if (!method_597)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_597)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_597, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = p1 ? mono_string_new (mono_domain_get (), [p1 UTF8String]) : NULL;
	mono_runtime_invoke (method_597, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar__UISearchBarDelegate_ShouldChangeTextInRange (id this, SEL sel, id p0, NSRange p1, NSString * p2)
{
	...
	if (!method_598)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_598)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_598, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	arg_ptrs [2] = p2 ? mono_string_new (mono_domain_get (), [p2 UTF8String]) : NULL;
	void* retval = (void *) mono_runtime_invoke (method_598, mthis, arg_ptrs, NULL);
	void * res;
	res = *(void * *) mono_object_unbox (retval);
	return res;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar__UISearchBarDelegate_SearchButtonClicked (id this, SEL sel, id p0)
{
	...
	if (!method_599)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_599)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_599, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_599, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar__UISearchBarDelegate_BookmarkButtonClicked (id this, SEL sel, id p0)
{
	...
	if (!method_600)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_600)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_600, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar__UISearchBarDelegate_CancelButtonClicked (id this, SEL sel, id p0)
{
	...
	if (!method_601)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_601)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_601, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_601, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar__UISearchBarDelegate_SelectedScopeButtonIndexChanged (id this, SEL sel, id p0, int p1)
{
	...
	if (!method_602)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_602)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_602, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar__UISearchBarDelegate_ListButtonClicked (id this, SEL sel, id p0)
{
	...
	if (!method_603)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_603)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_603, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_603, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar__UISearchBarDelegate_GetPositionForBar (id this, SEL sel, id p0)
{
	...
	if (!method_604)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_604)));
		}
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar__UISearchBarDelegate_RespondsToSelector (id this, SEL sel, SEL p0)
{
	...
	if (!method_605)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_605)));
		}
	arg_ptrs [0] = p0 ? monotouch_get_selector (p0) : NULL;
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar_UISearchBarAppearance_get_BackgroundImage (id this, SEL sel)
{
	...
	if (!method_606)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_606)));
		}
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar_UISearchBarAppearance_set_BackgroundImage (id this, SEL sel, id p0)
{
	...
	if (!method_607)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_607)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_607, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_607, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar_UISearchBarAppearance_get_ScopeBarBackgroundImage (id this, SEL sel)
{
	...
	if (!method_608)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_608)));
		}
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar_UISearchBarAppearance_set_ScopeBarBackgroundImage (id this, SEL sel, id p0)
{
	...
	if (!method_609)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_609)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_609, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar_UISearchBarAppearance_get_BarTintColor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_610)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_610)));
		}
	void* retval = (void *) mono_runtime_invoke (method_610, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar_UISearchBarAppearance_set_BarTintColor (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_611)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_611)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		nsobj0 = [nsobj0 copy];
		[nsobj0 autorelease];
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_611, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar_UISearchBarAppearance_SetSearchFieldBackgroundImage (id this, SEL sel, id p0, unsigned int p1)
{
	...
	if (!method_612)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_612)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_612, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar_UISearchBarAppearance_GetSearchFieldBackgroundImage (id this, SEL sel, unsigned int p0)
{
	...
	if (!method_613)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_613)));
		}
	arg_ptrs [0] = &p0;
	void* retval = (void *) mono_runtime_invoke (method_613, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar_UISearchBarAppearance_SetImageforSearchBarIcon (id this, SEL sel, id p0, int p1, unsigned int p2)
{
	...
	if (!method_614)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_614)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_614, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	arg_ptrs [2] = &p2;
	mono_runtime_invoke (method_614, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar_UISearchBarAppearance_GetImageForSearchBarIcon (id this, SEL sel, int p0, unsigned int p1)
{
	...
	if (!method_615)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_615)));
		}
	arg_ptrs [0] = &p0;
	arg_ptrs [1] = &p1;
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar_UISearchBarAppearance_SetScopeBarButtonBackgroundImage (id this, SEL sel, id p0, unsigned int p1)
{
	...
	if (!method_616)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_616)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_616, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	mono_runtime_invoke (method_616, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar_UISearchBarAppearance_GetScopeBarButtonBackgroundImage (id this, SEL sel, unsigned int p0)
{
	...
	if (!method_617)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_617)));
		}
	arg_ptrs [0] = &p0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar_UISearchBarAppearance_SetScopeBarButtonDividerImage (id this, SEL sel, id p0, unsigned int p1, unsigned int p2)
{
	...
	if (!method_618)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_618)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_618, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	arg_ptrs [2] = &p2;
	mono_runtime_invoke (method_618, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar_UISearchBarAppearance_GetScopeBarButtonDividerImage (id this, SEL sel, unsigned int p0, unsigned int p1)
{
	...
	if (!method_619)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_619)));
		}
	arg_ptrs [0] = &p0;
	arg_ptrs [1] = &p1;
	void* retval = (void *) mono_runtime_invoke (method_619, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar_UISearchBarAppearance__SetScopeBarButtonTitle (id this, SEL sel, id p0, unsigned int p1)
{
	...
	if (!method_620)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_620)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_620, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	mono_runtime_invoke (method_620, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar_UISearchBarAppearance__GetScopeBarButtonTitleTextAttributes (id this, SEL sel, unsigned int p0)
{
	...
	if (!method_621)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_621)));
		}
	arg_ptrs [0] = &p0;
	void* retval = (void *) mono_runtime_invoke (method_621, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar_UISearchBarAppearance_SetBackgroundImage (id this, SEL sel, id p0, int p1, int p2)
{
	void *arg_ptrs [3];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_622)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_622)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_622, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	arg_ptrs [2] = &p2;
	mono_runtime_invoke (method_622, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_623 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar_UISearchBarAppearance_BackgroundImageForBarPosition (id this, SEL sel, int p0, int p1)
{
	void *arg_ptrs [2];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_623)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_623)));
		}
	arg_ptrs [0] = &p0;
	arg_ptrs [1] = &p1;
	void* retval = (void *) mono_runtime_invoke (method_623, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar_UISearchBarAppearance_SetBackgroundImage1 (id this, SEL sel, id p0, int p1)
{
	void *arg_ptrs [2];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_624)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_624)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_624, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	mono_runtime_invoke (method_624, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_625 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar_UISearchBarAppearance_BackgroundImageForBarMetrics (id this, SEL sel, int p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_625)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_625)));
		}
	arg_ptrs [0] = &p0;
	void* retval = (void *) mono_runtime_invoke (method_625, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBar_UITabBarAppearance_get_SelectedImageTintColor (id this, SEL sel)
{
	...
	if (!method_626)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_626)));
		}
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBar_UITabBarAppearance_set_SelectedImageTintColor (id this, SEL sel, id p0)
{
	...
	if (!method_627)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_627)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_627, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBar_UITabBarAppearance_get_BackgroundImage (id this, SEL sel)
{
	...
	if (!method_628)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_628)));
		}
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBar_UITabBarAppearance_set_BackgroundImage (id this, SEL sel, id p0)
{
	...
	if (!method_629)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_629)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_629, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBar_UITabBarAppearance_get_SelectionIndicatorImage (id this, SEL sel)
{
	...
	if (!method_630)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_630)));
		}
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBar_UITabBarAppearance_set_SelectionIndicatorImage (id this, SEL sel, id p0)
{
	...
	if (!method_631)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_631)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_631, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBar_UITabBarAppearance_get_ShadowImage (id this, SEL sel)
{
	...
	if (!method_632)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_632)));
		}
...
native_to_managed_trampoline_MonoTouch_UIKit_UITabBar_UITabBarAppearance_set_ShadowImage (id this, SEL sel, id p0)
{
	...
	if (!method_633)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_633)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_633, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UITabBar_UITabBarAppearance_get_BarTintColor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_634)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_634)));
		}
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UITabBar_UITabBarAppearance_set_BarTintColor (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_635)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_635)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		nsobj0 = [nsobj0 copy];
		[nsobj0 autorelease];
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_635, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIImagePickerController__UIImagePickerControllerDelegate__ctor (id this, SEL sel)
{
	...
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_636));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_636, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIImagePickerController__UIImagePickerControllerDelegate_FinishedPickingImage (id this, SEL sel, id p0, id p1, id p2)
{
	...
	if (!method_637)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_637)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_637, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_637, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	NSObject *nsobj2 = (NSObject *) p2;
		MonoObject *mobj2 = NULL;
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_637, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIImagePickerController__UIImagePickerControllerDelegate_FinishedPickingMedia (id this, SEL sel, id p0, id p1)
{
	...
	if (!method_638)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_638)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_638, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_638, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	mono_runtime_invoke (method_638, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UIImagePickerController__UIImagePickerControllerDelegate_Canceled (id this, SEL sel, id p0)
{
	...
	if (!method_639)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_639)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_639, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
...
native_to_managed_trampoline_MonoTouch_UIKit_UIImagePickerController__UIImagePickerControllerDelegate_WillShowViewController (id this, SEL sel, id p0, id p1, bool p2)
{
	...
	if (!method_640)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_640)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_640, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_640, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	arg_ptrs [2] = &p2;
	mono_runtime_invoke (method_640, mthis, arg_ptrs, NULL);
	return NULL;
}
...
native_to_managed_trampoline_MonoTouch_UIKit_UIImagePickerController__UIImagePickerControllerDelegate_DidShowViewController (id this, SEL sel, id p0, id p1, bool p2)
{
	...
	if (!method_641)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_641)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_641, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_641, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	arg_ptrs [2] = &p2;
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIImagePickerController__UIImagePickerControllerDelegate_SupportedInterfaceOrientations (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_642)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_642)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_642, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	void* retval = (void *) mono_runtime_invoke (method_642, mthis, arg_ptrs, NULL);
	void * res;
	res = *(void * *) mono_object_unbox (retval);
	return res;
}
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIImagePickerController__UIImagePickerControllerDelegate_GetPreferredInterfaceOrientation (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_643)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_643)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_643, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	void* retval = (void *) mono_runtime_invoke (method_643, mthis, arg_ptrs, NULL);
	void * res;
	res = *(void * *) mono_object_unbox (retval);
	return res;
}
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIImagePickerController__UIImagePickerControllerDelegate_GetInteractionControllerForAnimationController (id this, SEL sel, id p0, id p1)
{
	void *arg_ptrs [2];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_644)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_644)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_644, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = monotouch_get_inative_object_static (p1, false, "MonoTouch.UIKit.UIViewControllerAnimatedTransitioningWrapper, monotouch", "MonoTouch.UIKit.IUIViewControllerAnimatedTransitioning, monotouch");
	void* retval = (void *) mono_runtime_invoke (method_644, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIImagePickerController__UIImagePickerControllerDelegate_GetAnimationControllerForOperation (id this, SEL sel, id p0, int p1, id p2, id p3)
{
	void *arg_ptrs [4];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_645)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_645)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_645, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	NSObject *nsobj2 = (NSObject *) p2;
		...
		bool created2 = false;
		if (nsobj2) {
			mobj2 = get_nsobject_with_type_for_ptr_created (nsobj2, false, monotouch_get_parameter_type (method_645, 2), &created2);
		}
		arg_ptrs [2] = mobj2;
	NSObject *nsobj3 = (NSObject *) p3;
		MonoObject *mobj3 = NULL;
		bool created3 = false;
		if (nsobj3) {
			mobj3 = get_nsobject_with_type_for_ptr_created (nsobj3, false, monotouch_get_parameter_type (method_645, 3), &created3);
		}
		arg_ptrs [3] = mobj3;
...
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIImagePickerController__UIImagePickerControllerDelegate_RespondsToSelector (id this, SEL sel, SEL p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (!method_646)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_646)));
		}
	arg_ptrs [0] = p0 ? monotouch_get_selector (p0) : NULL;
...
native_to_managed_trampoline_MonoTouch_UIKit_UINavigationBar_UINavigationBarAppearance_get__TitleTextAttributes (id this, SEL sel)
{
	...
	if (!method_647)
		...
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_647)));
		}
...
static MonoMethod *method_648 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UINavigationBar_UINavigationBarAppearance_set__TitleTextAttributes (id this, SEL sel, id p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_648)
		method_648 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_648)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		nsobj0 = [nsobj0 copy];
		[nsobj0 autorelease];
		...
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_648, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_648, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_649 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UINavigationBar_UINavigationBarAppearance_get_ShadowImage (id this, SEL sel)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_649)
		method_649 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_649)));
		}
	void* retval = (void *) mono_runtime_invoke (method_649, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_650 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UINavigationBar_UINavigationBarAppearance_set_ShadowImage (id this, SEL sel, id p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_650)
		method_650 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_650)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_650, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_650, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_651 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UINavigationBar_UINavigationBarAppearance_get_BarTintColor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_651)
		method_651 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_651)));
		}
	void* retval = (void *) mono_runtime_invoke (method_651, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_652 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UINavigationBar_UINavigationBarAppearance_set_BarTintColor (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_652)
		method_652 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_652)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_652, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_652, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_653 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UINavigationBar_UINavigationBarAppearance_get_BackIndicatorImage (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_653)
		method_653 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_653)));
		}
	void* retval = (void *) mono_runtime_invoke (method_653, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_654 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UINavigationBar_UINavigationBarAppearance_set_BackIndicatorImage (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_654)
		method_654 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_654)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_654, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_654, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_655 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UINavigationBar_UINavigationBarAppearance_get_BackIndicatorTransitionMaskImage (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_655)
		method_655 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_655)));
		}
	void* retval = (void *) mono_runtime_invoke (method_655, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_656 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UINavigationBar_UINavigationBarAppearance_set_BackIndicatorTransitionMaskImage (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_656)
		method_656 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_656)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_656, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_656, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_657 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UINavigationBar_UINavigationBarAppearance_SetBackgroundImage (id this, SEL sel, id p0, int p1)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_657)
		method_657 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_657)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_657, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	mono_runtime_invoke (method_657, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_658 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UINavigationBar_UINavigationBarAppearance_GetBackgroundImage (id this, SEL sel, int p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_658)
		method_658 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_658)));
		}
	arg_ptrs [0] = &p0;
	void* retval = (void *) mono_runtime_invoke (method_658, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_659 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UINavigationBar_UINavigationBarAppearance_SetTitleVerticalPositionAdjustment (id this, SEL sel, float p0, int p1)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_659)
		method_659 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_659)));
		}
	arg_ptrs [0] = &p0;
	arg_ptrs [1] = &p1;
	mono_runtime_invoke (method_659, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_660 = NULL;
float
native_to_managed_trampoline_MonoTouch_UIKit_UINavigationBar_UINavigationBarAppearance_GetTitleVerticalPositionAdjustment (id this, SEL sel, int p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_660)
		method_660 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_660)));
		}
	arg_ptrs [0] = &p0;
	void* retval = (void *) mono_runtime_invoke (method_660, mthis, arg_ptrs, NULL);
	float res;
	res = *(float *) mono_object_unbox (retval);
	return res;
}

static MonoMethod *method_661 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UINavigationBar_UINavigationBarAppearance_SetBackgroundImage1 (id this, SEL sel, id p0, int p1, int p2)
{
	void *arg_ptrs [3];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_661)
		method_661 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_661)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_661, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	arg_ptrs [2] = &p2;
	mono_runtime_invoke (method_661, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_662 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UINavigationBar_UINavigationBarAppearance_GetBackgroundImage1 (id this, SEL sel, int p0, int p1)
{
	void *arg_ptrs [2];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_662)
		method_662 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_662)));
		}
	arg_ptrs [0] = &p0;
	arg_ptrs [1] = &p1;
	void* retval = (void *) mono_runtime_invoke (method_662, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_663 = NULL;
void *
native_to_managed_trampoline_Xamarin_iOS_ZBar_BarcodeScanDelegate__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (monotouch_try_get_nsobject (this))
		return this;
	if (!method_663)
		method_663 = get_method_for_selector ([this class], sel).method->method;
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_663));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_663, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
static MonoMethod *method_664 = NULL;
void *
native_to_managed_trampoline_Xamarin_iOS_ZBar_BarcodeScanDelegate_FinishedPickingMedia (id this, SEL sel, id p0, id p1)
{
	void *arg_ptrs [2];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_664)
		method_664 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_664)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_664, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	NSObject *nsobj1 = (NSObject *) p1;
		MonoObject *mobj1 = NULL;
		bool created1 = false;
		if (nsobj1) {
			mobj1 = get_nsobject_with_type_for_ptr_created (nsobj1, false, monotouch_get_parameter_type (method_664, 1), &created1);
		}
		arg_ptrs [1] = mobj1;
	mono_runtime_invoke (method_664, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_665 = NULL;
void *
native_to_managed_trampoline_Xamarin_iOS_ZBar_BarcodeScanDelegate_Canceled (id this, SEL sel, id p0)
{
	void *arg_ptrs [1];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_665)
		method_665 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_665)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_665, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_665, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_666 = NULL;
void *
native_to_managed_trampoline_ZBar_ZBarReaderViewController__ZBarReaderDelegate__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (monotouch_try_get_nsobject (this))
		return this;
	if (!method_666)
		method_666 = get_method_for_selector ([this class], sel).method->method;
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_666));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_666, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
static MonoMethod *method_667 = NULL;
void *
native_to_managed_trampoline_ZBar_ZBarReaderViewController__ZBarReaderDelegate_BarcodeNotFound (id this, SEL sel, id p0, bool p1)
{
	void *arg_ptrs [2];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_667)
		method_667 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_667)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_667, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	mono_runtime_invoke (method_667, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_668 = NULL;
void *
native_to_managed_trampoline_Xamarin_iOS_ZBar_ZBarScanner__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (monotouch_try_get_nsobject (this))
		return this;
	if (!method_668)
		method_668 = get_method_for_selector ([this class], sel).method->method;
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_668));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_668, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
static MonoMethod *method_669 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIStepper_UIStepperAppearance_SetBackgroundImage (id this, SEL sel, id p0, unsigned int p1)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_669)
		method_669 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_669)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_669, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	mono_runtime_invoke (method_669, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_670 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIStepper_UIStepperAppearance_BackgroundImage (id this, SEL sel, unsigned int p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_670)
		method_670 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_670)));
		}
	arg_ptrs [0] = &p0;
	void* retval = (void *) mono_runtime_invoke (method_670, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_671 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIStepper_UIStepperAppearance_SetDividerImage (id this, SEL sel, id p0, unsigned int p1, unsigned int p2)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_671)
		method_671 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_671)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_671, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	arg_ptrs [2] = &p2;
	mono_runtime_invoke (method_671, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_672 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIStepper_UIStepperAppearance_GetDividerImage (id this, SEL sel, unsigned int p0, unsigned int p1)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_672)
		method_672 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_672)));
		}
	arg_ptrs [0] = &p0;
	arg_ptrs [1] = &p1;
	void* retval = (void *) mono_runtime_invoke (method_672, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_673 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIStepper_UIStepperAppearance_SetIncrementImage (id this, SEL sel, id p0, unsigned int p1)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_673)
		method_673 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_673)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_673, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	mono_runtime_invoke (method_673, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_674 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIStepper_UIStepperAppearance_GetIncrementImage (id this, SEL sel, unsigned int p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_674)
		method_674 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_674)));
		}
	arg_ptrs [0] = &p0;
	void* retval = (void *) mono_runtime_invoke (method_674, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_675 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIStepper_UIStepperAppearance_SetDecrementImage (id this, SEL sel, id p0, unsigned int p1)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_675)
		method_675 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_675)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_675, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	mono_runtime_invoke (method_675, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_676 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIStepper_UIStepperAppearance_GetDecrementImage (id this, SEL sel, unsigned int p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_676)
		method_676 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_676)));
		}
	arg_ptrs [0] = &p0;
	void* retval = (void *) mono_runtime_invoke (method_676, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_677 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISegmentedControl_UISegmentedControlAppearance_SetBackgroundImage (id this, SEL sel, id p0, unsigned int p1, int p2)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_677)
		method_677 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_677)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_677, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	arg_ptrs [2] = &p2;
	mono_runtime_invoke (method_677, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_678 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISegmentedControl_UISegmentedControlAppearance_GetBackgroundImage (id this, SEL sel, unsigned int p0, int p1)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_678)
		method_678 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_678)));
		}
	arg_ptrs [0] = &p0;
	arg_ptrs [1] = &p1;
	void* retval = (void *) mono_runtime_invoke (method_678, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_679 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISegmentedControl_UISegmentedControlAppearance_SetDividerImage (id this, SEL sel, id p0, unsigned int p1, unsigned int p2, int p3)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_679)
		method_679 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_679)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_679, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	arg_ptrs [2] = &p2;
	arg_ptrs [3] = &p3;
	mono_runtime_invoke (method_679, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_680 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISegmentedControl_UISegmentedControlAppearance_DividerImageForLeftSegmentStaterightSegmentStatebarMetrics (id this, SEL sel, unsigned int p0, unsigned int p1, int p2)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_680)
		method_680 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_680)));
		}
	arg_ptrs [0] = &p0;
	arg_ptrs [1] = &p1;
	arg_ptrs [2] = &p2;
	void* retval = (void *) mono_runtime_invoke (method_680, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_681 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISegmentedControl_UISegmentedControlAppearance__SetTitleTextAttributes (id this, SEL sel, id p0, unsigned int p1)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_681)
		method_681 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_681)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_681, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	mono_runtime_invoke (method_681, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_682 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISegmentedControl_UISegmentedControlAppearance__GetTitleTextAttributes (id this, SEL sel, unsigned int p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_682)
		method_682 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_682)));
		}
	arg_ptrs [0] = &p0;
	void* retval = (void *) mono_runtime_invoke (method_682, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_683 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISegmentedControl_UISegmentedControlAppearance_SetContentPositionAdjustment (id this, SEL sel, UIOffset p0, int p1, int p2)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_683)
		method_683 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_683)));
		}
	arg_ptrs [0] = &p0;
	arg_ptrs [1] = &p1;
	arg_ptrs [2] = &p2;
	mono_runtime_invoke (method_683, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_684 = NULL;
void
native_to_managed_trampoline_MonoTouch_UIKit_UISegmentedControl_UISegmentedControlAppearance_ContentPositionAdjustment (void *buffer, id this, SEL sel, int p0, int p1)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_684)
		method_684 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_684)));
		}
	arg_ptrs [0] = &p0;
	arg_ptrs [1] = &p1;
	void* retval = (void *) mono_runtime_invoke (method_684, mthis, arg_ptrs, NULL);
	memcpy (buffer, mono_object_unbox (retval), 8);
}

static MonoMethod *method_685 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UITableView_UITableViewAppearance_get_SectionIndexColor (id this, SEL sel)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_685)
		method_685 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_685)));
		}
	void* retval = (void *) mono_runtime_invoke (method_685, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_686 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UITableView_UITableViewAppearance_set_SectionIndexColor (id this, SEL sel, id p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_686)
		method_686 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_686)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_686, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_686, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_687 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UITableView_UITableViewAppearance_get_SectionIndexTrackingBackgroundColor (id this, SEL sel)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_687)
		method_687 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_687)));
		}
	void* retval = (void *) mono_runtime_invoke (method_687, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_688 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UITableView_UITableViewAppearance_set_SectionIndexTrackingBackgroundColor (id this, SEL sel, id p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_688)
		method_688 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_688)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_688, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_688, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_689 = NULL;
void *
native_to_managed_trampoline_MonoTouch_CoreImage_CIBlendWithAlphaMask__ctor (id this, SEL sel)
{
	void *arg_ptrs [0];
	MonoObject *mthis;
	if (mono_domain_get () == NULL)
	...
	if (monotouch_try_get_nsobject (this))
		return this;
	if (!method_689)
		method_689 = get_method_for_selector ([this class], sel).method->method;
	int handle = (int) this;
	handle |= 1;
	mthis = mono_object_new (mono_domain_get (), mono_method_get_class (method_689));
	mono_field_set_value (mthis, monotouch_nsobject_handle_field, &handle);
	mono_runtime_invoke (method_689, mthis, arg_ptrs, NULL);
	monotouch_create_managed_ref (this, mthis, true);
	void *params[2];
	params[0] = mthis;
	params[1] = &this;
...
static MonoMethod *method_690 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIButton_UIButtonAppearance_get_CurrentTitleColor (id this, SEL sel)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_690)
		method_690 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_690)));
		}
	void* retval = (void *) mono_runtime_invoke (method_690, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_691 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIButton_UIButtonAppearance_get_CurrentTitleShadowColor (id this, SEL sel)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_691)
		method_691 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_691)));
		}
	void* retval = (void *) mono_runtime_invoke (method_691, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_692 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIButton_UIButtonAppearance_get_CurrentImage (id this, SEL sel)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_692)
		method_692 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_692)));
		}
	void* retval = (void *) mono_runtime_invoke (method_692, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_693 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIButton_UIButtonAppearance_get_CurrentBackgroundImage (id this, SEL sel)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_693)
		method_693 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_693)));
		}
	void* retval = (void *) mono_runtime_invoke (method_693, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_694 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIButton_UIButtonAppearance_SetTitleColor (id this, SEL sel, id p0, unsigned int p1)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_694)
		method_694 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_694)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_694, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	mono_runtime_invoke (method_694, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_695 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIButton_UIButtonAppearance_SetTitleShadowColor (id this, SEL sel, id p0, unsigned int p1)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_695)
		method_695 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_695)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_695, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	mono_runtime_invoke (method_695, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_696 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIButton_UIButtonAppearance_SetImage (id this, SEL sel, id p0, unsigned int p1)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_696)
		method_696 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_696)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_696, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	mono_runtime_invoke (method_696, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_697 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIButton_UIButtonAppearance_SetBackgroundImage (id this, SEL sel, id p0, unsigned int p1)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_697)
		method_697 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_697)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_697, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	mono_runtime_invoke (method_697, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_698 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIButton_UIButtonAppearance_TitleColor (id this, SEL sel, unsigned int p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_698)
		method_698 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_698)));
		}
	arg_ptrs [0] = &p0;
	void* retval = (void *) mono_runtime_invoke (method_698, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_699 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIButton_UIButtonAppearance_TitleShadowColor (id this, SEL sel, unsigned int p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_699)
		method_699 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_699)));
		}
	arg_ptrs [0] = &p0;
	void* retval = (void *) mono_runtime_invoke (method_699, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_700 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIButton_UIButtonAppearance_ImageForState (id this, SEL sel, unsigned int p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_700)
		method_700 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_700)));
		}
	arg_ptrs [0] = &p0;
	void* retval = (void *) mono_runtime_invoke (method_700, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_701 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIButton_UIButtonAppearance_BackgroundImageForState (id this, SEL sel, unsigned int p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_701)
		method_701 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_701)));
		}
	arg_ptrs [0] = &p0;
	void* retval = (void *) mono_runtime_invoke (method_701, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_702 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISlider_UISliderAppearance_get_MinValueImage (id this, SEL sel)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_702)
		method_702 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_702)));
		}
	void* retval = (void *) mono_runtime_invoke (method_702, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_703 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISlider_UISliderAppearance_set_MinValueImage (id this, SEL sel, id p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_703)
		method_703 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_703)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_703, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_703, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_704 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISlider_UISliderAppearance_get_MaxValueImage (id this, SEL sel)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_704)
		method_704 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_704)));
		}
	void* retval = (void *) mono_runtime_invoke (method_704, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_705 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISlider_UISliderAppearance_set_MaxValueImage (id this, SEL sel, id p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_705)
		method_705 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_705)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_705, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_705, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_706 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISlider_UISliderAppearance_get_MinimumTrackTintColor (id this, SEL sel)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_706)
		method_706 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_706)));
		}
	void* retval = (void *) mono_runtime_invoke (method_706, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_707 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISlider_UISliderAppearance_set_MinimumTrackTintColor (id this, SEL sel, id p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_707)
		method_707 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_707)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_707, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_707, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_708 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISlider_UISliderAppearance_get_MaximumTrackTintColor (id this, SEL sel)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_708)
		method_708 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_708)));
		}
	void* retval = (void *) mono_runtime_invoke (method_708, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_709 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISlider_UISliderAppearance_set_MaximumTrackTintColor (id this, SEL sel, id p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_709)
		method_709 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_709)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_709, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_709, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_710 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISlider_UISliderAppearance_get_ThumbTintColor (id this, SEL sel)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_710)
		method_710 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_710)));
		}
	void* retval = (void *) mono_runtime_invoke (method_710, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_711 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISlider_UISliderAppearance_set_ThumbTintColor (id this, SEL sel, id p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_711)
		method_711 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_711)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_711, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_711, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_712 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISlider_UISliderAppearance_SetThumbImage (id this, SEL sel, id p0, unsigned int p1)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_712)
		method_712 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_712)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_712, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	mono_runtime_invoke (method_712, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_713 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISlider_UISliderAppearance_SetMinTrackImage (id this, SEL sel, id p0, unsigned int p1)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_713)
		method_713 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_713)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_713, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	mono_runtime_invoke (method_713, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_714 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISlider_UISliderAppearance_SetMaxTrackImage (id this, SEL sel, id p0, unsigned int p1)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_714)
		method_714 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_714)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_714, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	arg_ptrs [1] = &p1;
	mono_runtime_invoke (method_714, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_715 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISlider_UISliderAppearance_ThumbImage (id this, SEL sel, unsigned int p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_715)
		method_715 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_715)));
		}
	arg_ptrs [0] = &p0;
	void* retval = (void *) mono_runtime_invoke (method_715, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_716 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISlider_UISliderAppearance_MinTrackImage (id this, SEL sel, unsigned int p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_716)
		method_716 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_716)));
		}
	arg_ptrs [0] = &p0;
	void* retval = (void *) mono_runtime_invoke (method_716, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_717 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISlider_UISliderAppearance_MaxTrackImage (id this, SEL sel, unsigned int p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_717)
		method_717 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_717)));
		}
	arg_ptrs [0] = &p0;
	void* retval = (void *) mono_runtime_invoke (method_717, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_718 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISwitch_UISwitchAppearance_get_OnTintColor (id this, SEL sel)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_718)
		method_718 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_718)));
		}
	void* retval = (void *) mono_runtime_invoke (method_718, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_719 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISwitch_UISwitchAppearance_set_OnTintColor (id this, SEL sel, id p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_719)
		method_719 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_719)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_719, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_719, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_720 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISwitch_UISwitchAppearance_get_ThumbTintColor (id this, SEL sel)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_720)
		method_720 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_720)));
		}
	void* retval = (void *) mono_runtime_invoke (method_720, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_721 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISwitch_UISwitchAppearance_set_ThumbTintColor (id this, SEL sel, id p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_721)
		method_721 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_721)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_721, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_721, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_722 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISwitch_UISwitchAppearance_get_OnImage (id this, SEL sel)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_722)
		method_722 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_722)));
		}
	void* retval = (void *) mono_runtime_invoke (method_722, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_723 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISwitch_UISwitchAppearance_set_OnImage (id this, SEL sel, id p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_723)
		method_723 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_723)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_723, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_723, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_724 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISwitch_UISwitchAppearance_get_OffImage (id this, SEL sel)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_724)
		method_724 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_724)));
		}
	void* retval = (void *) mono_runtime_invoke (method_724, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_725 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UISwitch_UISwitchAppearance_set_OffImage (id this, SEL sel, id p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_725)
		method_725 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_725)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_725, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_725, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_726 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIPageControl_UIPageControlAppearance_get_PageIndicatorTintColor (id this, SEL sel)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_726)
		method_726 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_726)));
		}
	void* retval = (void *) mono_runtime_invoke (method_726, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_727 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIPageControl_UIPageControlAppearance_set_PageIndicatorTintColor (id this, SEL sel, id p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_727)
		method_727 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_727)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_727, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_727, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_728 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIPageControl_UIPageControlAppearance_get_CurrentPageIndicatorTintColor (id this, SEL sel)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_728)
		method_728 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_728)));
		}
	void* retval = (void *) mono_runtime_invoke (method_728, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_729 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIPageControl_UIPageControlAppearance_set_CurrentPageIndicatorTintColor (id this, SEL sel, id p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_729)
		method_729 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_729)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_729, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_729, mthis, arg_ptrs, NULL);
	return NULL;
}

static MonoMethod *method_730 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIRefreshControl_UIRefreshControlAppearance_get_AttributedTitle (id this, SEL sel)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_730)
		method_730 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_730)));
		}
	void* retval = (void *) mono_runtime_invoke (method_730, mthis, arg_ptrs, NULL);
	void * res;
	if (!retval) {
		res = NULL;
	} else {
...
static MonoMethod *method_731 = NULL;
void *
native_to_managed_trampoline_MonoTouch_UIKit_UIRefreshControl_UIRefreshControlAppearance_set_AttributedTitle (id this, SEL sel, id p0)
{
	...
	if (mono_domain_get () == NULL)
		mono_jit_thread_attach (NULL);
	if (!method_731)
		method_731 = get_method_for_selector ([this class], sel).method->method;
		mthis = NULL;
		if (this) {
			mthis = get_nsobject_with_type_for_ptr (this, false, mono_class_get_type (mono_method_get_class (method_731)));
		}
	NSObject *nsobj0 = (NSObject *) p0;
		MonoObject *mobj0 = NULL;
		bool created0 = false;
		if (nsobj0) {
			mobj0 = get_nsobject_with_type_for_ptr_created (nsobj0, false, monotouch_get_parameter_type (method_731, 0), &created0);
		}
		arg_ptrs [0] = mobj0;
	mono_runtime_invoke (method_731, mthis, arg_ptrs, NULL);
	return NULL;
}
...
static MTClassMap __monotouch_class_map [] = {
	...
	{"AVAssetTrackGroup", "MonoTouch.AVFoundation.AVAssetTrackGroup, monotouch", 0},
	...
	{"JSValue", "MonoTouch.JavaScriptCore.JSValue, monotouch", 0},
	{"JSContext", "MonoTouch.JavaScriptCore.JSContext, monotouch", 0},
	...
	{"AVAsynchronousVideoCompositionRequest", "MonoTouch.AVFoundation.AVAsynchronousVideoCompositionRequest, monotouch", 0},
	{"AVFrameRateRange", "MonoTouch.AVFoundation.AVFrameRateRange, monotouch", 0},
	...
	{"SSReadingList", "MonoTouch.SafariServices.SSReadingList, monotouch", 0},
	...
	{"AVCaptureDeviceFormat", "MonoTouch.AVFoundation.AVCaptureDeviceFormat, monotouch", 0},
	{"UIDevice", "MonoTouch.UIKit.UIDevice, monotouch", 0},
	{"AVPlayerMediaSelectionCriteria", "MonoTouch.AVFoundation.AVPlayerMediaSelectionCriteria, monotouch", 0},
	...
	{"NSLayoutManager", "MonoTouch.UIKit.NSLayoutManager, monotouch", 0},
	{"SKKeyframeSequence", "MonoTouch.SpriteKit.SKKeyframeSequence, monotouch", 0},
	{"SKAction", "MonoTouch.SpriteKit.SKAction, monotouch", 0},
	...
	{"AVVideoCompositionRenderContext", "MonoTouch.AVFoundation.AVVideoCompositionRenderContext, monotouch", 0},
	...
	{"UIDynamicAnimator", "MonoTouch.UIKit.UIDynamicAnimator, monotouch", 0},
	...
	{"UIPercentDrivenInteractiveTransition", "MonoTouch.UIKit.UIPercentDrivenInteractiveTransition, monotouch", 0},
	...
	{"CTSubscriber", "MonoTouch.CoreTelephony.CTSubscriber, monotouch", 0},
	{"CTSubscriberInfo", "MonoTouch.CoreTelephony.CTSubscriberInfo, monotouch", 0},
	{"EKObject", "MonoTouch.EventKit.EKObject, monotouch", 0},
	{"MKDirectionsResponse", "MonoTouch.MapKit.MKDirectionsResponse, monotouch", 0},
	{"MKRoute", "MonoTouch.MapKit.MKRoute, monotouch", 0},
	{"MKRouteStep", "MonoTouch.MapKit.MKRouteStep, monotouch", 0},
	{"MKMapCamera", "MonoTouch.MapKit.MKMapCamera, monotouch", 0},
	{"MKMapSnapshot", "MonoTouch.MapKit.MKMapSnapshot, monotouch", 0},
	{"MKMapSnapshotOptions", "MonoTouch.MapKit.MKMapSnapshotOptions, monotouch", 0},
	{"MKETAResponse", "MonoTouch.MapKit.MKETAResponse, monotouch", 0},
	...
	{"MKDirections", "MonoTouch.MapKit.MKDirections, monotouch", 0},
	{"MKDirectionsRequest", "MonoTouch.MapKit.MKDirectionsRequest, monotouch", 0},
	{"MKMapSnapshotter", "MonoTouch.MapKit.MKMapSnapshotter, monotouch", 0},
	...
	{"UIMotionEffect", "MonoTouch.UIKit.UIMotionEffect, monotouch", 0},
	...
	{"JSManagedValue", "MonoTouch.JavaScriptCore.JSManagedValue, monotouch", 0},
	{"JSVirtualMachine", "MonoTouch.JavaScriptCore.JSVirtualMachine, monotouch", 0},
	{"GCControllerElement", "MonoTouch.GameController.GCControllerElement, monotouch", 0},
	{"UIDocument", "MonoTouch.UIKit.UIDocument, monotouch", 0},
	{"SKPhysicsWorld", "MonoTouch.SpriteKit.SKPhysicsWorld, monotouch", 0},
	{"UICollectionViewUpdateItem", "MonoTouch.UIKit.UICollectionViewUpdateItem, monotouch", 0},
	{"SKPhysicsJoint", "MonoTouch.SpriteKit.SKPhysicsJoint, monotouch", 0},
	{"UICollectionViewLayoutInvalidationContext", "MonoTouch.UIKit.UICollectionViewLayoutInvalidationContext, monotouch", 0},
	{"GCExtendedGamepad", "MonoTouch.GameController.GCExtendedGamepad, monotouch", 0},
	...
	{"NSTextTab", "MonoTouch.UIKit.NSTextTab, monotouch", 0},
	...
	{"GCGamepad", "MonoTouch.GameController.GCGamepad, monotouch", 0},
	...
	{"CMMotionActivityManager", "MonoTouch.CoreMotion.CMMotionActivityManager, monotouch", 0},
	{"UIMenuItem", "MonoTouch.UIKit.UIMenuItem, monotouch", 0},
	{"CMMotionActivity", "MonoTouch.CoreMotion.CMMotionActivity, monotouch", 0},
	{"UIBezierPath", "MonoTouch.UIKit.UIBezierPath, monotouch", 0},
	{"SKPhysicsBody", "MonoTouch.SpriteKit.SKPhysicsBody, monotouch", 0},
	{"UITextRange", "MonoTouch.UIKit.UITextRange, monotouch", 0},
	{"UITextPosition", "MonoTouch.UIKit.UITextPosition, monotouch", 0},
	{"UIKeyCommand", "MonoTouch.UIKit.UIKeyCommand, monotouch", 0},
	{"SKPhysicsContact", "MonoTouch.SpriteKit.SKPhysicsContact, monotouch", 0},
	{"UIDynamicBehavior", "MonoTouch.UIKit.UIDynamicBehavior, monotouch", 0},
	{"SKTransition", "MonoTouch.SpriteKit.SKTransition, monotouch", 0},
	{"SKTexture", "MonoTouch.SpriteKit.SKTexture, monotouch", 0},
	{"SKTextureAtlas", "MonoTouch.SpriteKit.SKTextureAtlas, monotouch", 0},
	...
	{"NSInvocation", "MonoTouch.Foundation.NSInvocation, monotouch", 0},
	{"NSMethodSignature", "MonoTouch.Foundation.NSMethodSignature, monotouch", 0},
	...
	{"NSURLSessionConfiguration", "MonoTouch.Foundation.NSUrlSessionConfiguration, monotouch", 0},
	...
	{"NSPort", "MonoTouch.Foundation.NSPort, monotouch", 0},
	{"NSPortMessage", "MonoTouch.Foundation.NSPortMessage, monotouch", 0},
	...
	{"NSURLSessionTask", "MonoTouch.Foundation.NSUrlSessionTask, monotouch", 0},
	...
	{"NSURLComponents", "MonoTouch.Foundation.NSUrlComponents, monotouch", 0},
	...
	{"NSURLSession", "MonoTouch.Foundation.NSUrlSession, monotouch", 0},
	...
	{"ZBarImageScanner", "ZBar.ZBarImageScanner, ZBar", 0},
	{"AVAssetImageGenerator", "MonoTouch.AVFoundation.AVAssetImageGenerator, monotouch", 0},
	{"ZBarSymbol", "ZBar.ZBarSymbol, ZBar", 0},
	{"ZBarSymbolSet", "ZBar.ZBarSymbolSet, ZBar", 0},
	...
	{"AVMetadataItemFilter", "MonoTouch.AVFoundation.AVMetadataItemFilter, monotouch", 0},
	...
	{"GKLeaderboardSet", "MonoTouch.GameKit.GKLeaderboardSet, monotouch", 0},
	...
	{"AVOutputSettingsAssistant", "MonoTouch.AVFoundation.AVOutputSettingsAssistant, monotouch", 0},
	...
	{"UIFontDescriptor", "MonoTouch.UIKit.UIFontDescriptor, monotouch", 0},
	...
	{"GKTurnBasedExchange", "MonoTouch.GameKit.GKTurnBasedExchange, monotouch", 0},
	{"CLRegion", "MonoTouch.CoreLocation.CLRegion, monotouch", 0},
	{"CLHeading", "MonoTouch.CoreLocation.CLHeading, monotouch", 0},
	{"GKTurnBasedExchangeReply", "MonoTouch.GameKit.GKTurnBasedExchangeReply, monotouch", 0},
	...
	{"CAEmitterBehavior", "MonoTouch.CoreAnimation.CAEmitterBehavior, monotouch", 0},
	...
	{"GCController", "MonoTouch.GameController.GCController, monotouch", 0},
	...
	{"SKReceiptRefreshRequest", "MonoTouch.StoreKit.SKReceiptRefreshRequest, monotouch", 0},
	{"SKProductsRequest", "MonoTouch.StoreKit.SKProductsRequest, monotouch", 0},
	{"MKOverlayPathRenderer", "MonoTouch.MapKit.MKOverlayPathRenderer, monotouch", 0},
	{"NSAtomicStore", "MonoTouch.CoreData.NSAtomicStore, monotouch", 0},
	{"AVSynchronizedLayer", "MonoTouch.AVFoundation.AVSynchronizedLayer, monotouch", 0},
	...
	{"MKTileOverlayRenderer", "MonoTouch.MapKit.MKTileOverlayRenderer, monotouch", 0},
	...
	{"AVPlayerItemLegibleOutput", "MonoTouch.AVFoundation.AVPlayerItemLegibleOutput, monotouch", 0},
	...
	{"MKDistanceFormatter", "MonoTouch.MapKit.MKDistanceFormatter, monotouch", 0},
	...
	{"GCControllerButtonInput", "MonoTouch.GameController.GCControllerButtonInput, monotouch", 0},
	...
	{"GCControllerDirectionPad", "MonoTouch.GameController.GCControllerDirectionPad, monotouch", 0},
	{"NSURLSessionDownloadTask", "MonoTouch.Foundation.NSUrlSessionDownloadTask, monotouch", 0},
	{"NSURLSessionUploadTask", "MonoTouch.Foundation.NSUrlSessionUploadTask, monotouch", 0},
	{"GCControllerAxisInput", "MonoTouch.GameController.GCControllerAxisInput, monotouch", 0},
	{"SKPhysicsJointFixed", "MonoTouch.SpriteKit.SKPhysicsJointFixed, monotouch", 0},
	{"SKPhysicsJointSliding", "MonoTouch.SpriteKit.SKPhysicsJointSliding, monotouch", 0},
	{"SKPhysicsJointLimit", "MonoTouch.SpriteKit.SKPhysicsJointLimit, monotouch", 0},
	...
	{"NSURLSessionDataTask", "MonoTouch.Foundation.NSUrlSessionDataTask, monotouch", 0},
	...
	{"NSMutableCharacterSet", "MonoTouch.Foundation.NSMutableCharacterSet, monotouch", 0},
	...
	{"AVAssetWriterInputGroup", "MonoTouch.AVFoundation.AVAssetWriterInputGroup, monotouch", 0},
	...
	{"SKPhysicsJointSpring", "MonoTouch.SpriteKit.SKPhysicsJointSpring, monotouch", 0},
	...
	{"NSMachPort", "MonoTouch.Foundation.NSMachPort, monotouch", 0},
	...
	{"MonoTouch.SpriteKit.SKPhysicsWorld+_SKPhysicsContactDelegate", "MonoTouch.SpriteKit.SKPhysicsWorld+_SKPhysicsContactDelegate, monotouch", 0},
	...
	{"SKPhysicsJointPin", "MonoTouch.SpriteKit.SKPhysicsJointPin, monotouch", 0},
	...
	{"SKNode", "MonoTouch.SpriteKit.SKNode, monotouch", 0},
	...
	{"UIPushBehavior", "MonoTouch.UIKit.UIPushBehavior, monotouch", 0},
	...
	{"MonoTouch.UIKit.NSTextStorage+_NSTextStorageDelegate", "MonoTouch.UIKit.NSTextStorage+_NSTextStorageDelegate, monotouch", 0},
	...
	{"MonoTouch.AVFoundation.AVSpeechSynthesizer+_AVSpeechSynthesizerDelegate", "MonoTouch.AVFoundation.AVSpeechSynthesizer+_AVSpeechSynthesizerDelegate, monotouch", 0},
	...
	{"MonoTouch.CoreImage.CIVignetteEffect", "MonoTouch.CoreImage.CIVignetteEffect, monotouch", 0},
	{"MonoTouch.CoreImage.CISRGBToneCurveToLinear", "MonoTouch.CoreImage.CISRGBToneCurveToLinear, monotouch", 0},
	...
	{"NSMutableString", "MonoTouch.Foundation.NSMutableString, monotouch", 0},
	...
	{"MonoTouch.CoreImage.CILinearToSRGBToneCurve", "MonoTouch.CoreImage.CILinearToSRGBToneCurve, monotouch", 0},
	{"MonoTouch.MapKit.MKMapView+_MKMapViewDelegate", "MonoTouch.MapKit.MKMapView+_MKMapViewDelegate, monotouch", 0},
	{"MonoTouch.CoreImage.CIPhotoEffect", "MonoTouch.CoreImage.CIPhotoEffect, monotouch", 0},
	{"GCGamepadSnapshot", "MonoTouch.GameController.GCGamepadSnapshot, monotouch", 0},
	{"GCExtendedGamepadSnapshot", "MonoTouch.GameController.GCExtendedGamepadSnapshot, monotouch", 0},
	{"CMAccelerometerData", "MonoTouch.CoreMotion.CMAccelerometerData, monotouch", 0},
	{"MonoTouch.CoreImage.CIConvolutionCore", "MonoTouch.CoreImage.CIConvolutionCore, monotouch", 0},
	...
	{"MonoTouch.CoreImage.CIColorCrossPolynomial", "MonoTouch.CoreImage.CIColorCrossPolynomial, monotouch", 0},
	...
	{"MonoTouch.CoreImage.CIColorClamp", "MonoTouch.CoreImage.CIColorClamp, monotouch", 0},
	...
	{"UISnapBehavior", "MonoTouch.UIKit.UISnapBehavior, monotouch", 0},
	{"AppDelegate", "Xamarin.iOS.ZBar.Demo.AppDelegate, XamariniOSZBarDemo", 0},
	...
	{"UIMotionEffectGroup", "MonoTouch.UIKit.UIMotionEffectGroup, monotouch", 0},
	{"UIInterpolatingMotionEffect", "MonoTouch.UIKit.UIInterpolatingMotionEffect, monotouch", 0},
	...
	{"UICollisionBehavior", "MonoTouch.UIKit.UICollisionBehavior, monotouch", 0},
	{"UIDynamicItemBehavior", "MonoTouch.UIKit.UIDynamicItemBehavior, monotouch", 0},
	{"UIGravityBehavior", "MonoTouch.UIKit.UIGravityBehavior, monotouch", 0},
	...
	{"MonoTouch.UIKit.UICollisionBehavior+_UICollisionBehaviorDelegate", "MonoTouch.UIKit.UICollisionBehavior+_UICollisionBehaviorDelegate, monotouch", 0},
	...
	{"UIAttachmentBehavior", "MonoTouch.UIKit.UIAttachmentBehavior, monotouch", 0},
	{"UICollectionViewFlowLayout", "MonoTouch.UIKit.UICollectionViewFlowLayout, monotouch", 0},
	{"UICollectionViewFlowLayoutInvalidationContext", "MonoTouch.UIKit.UICollectionViewFlowLayoutInvalidationContext, monotouch", 0},
	{"UICollectionViewTransitionLayout", "MonoTouch.UIKit.UICollectionViewTransitionLayout, monotouch", 0},
	{"MonoTouch.CoreImage.CICompositingFilter", "MonoTouch.CoreImage.CICompositingFilter, monotouch", 0},
	{"MonoTouch.CoreImage.CIPhotoEffectMono", "MonoTouch.CoreImage.CIPhotoEffectMono, monotouch", 0},
	{"MonoTouch.CoreImage.CIPhotoEffectNoir", "MonoTouch.CoreImage.CIPhotoEffectNoir, monotouch", 0},
	{"MonoTouch.CoreImage.CIMaximumCompositing", "MonoTouch.CoreImage.CIMaximumCompositing, monotouch", 0},
	{"MonoTouch.CoreImage.CIPhotoEffectProcess", "MonoTouch.CoreImage.CIPhotoEffectProcess, monotouch", 0},
	{"MonoTouch.CoreImage.CIPhotoEffectTonal", "MonoTouch.CoreImage.CIPhotoEffectTonal, monotouch", 0},
	...
	{"MonoTouch.CoreImage.CIPhotoEffectFade", "MonoTouch.CoreImage.CIPhotoEffectFade, monotouch", 0},
	...
	{"MonoTouch.CoreImage.CIPhotoEffectInstant", "MonoTouch.CoreImage.CIPhotoEffectInstant, monotouch", 0},
	...
	{"ZBarDemoViewController", "Xamarin.iOS.ZBar.Demo.ZBarDemoViewController, XamariniOSZBarDemo", 0},
	{"ZBarReaderDelegate", "ZBar.ZBarReaderDelegate, ZBar", 0},
	{"MonoTouch.CoreImage.CIPhotoEffectTransfer", "MonoTouch.CoreImage.CIPhotoEffectTransfer, monotouch", 0},
	...
	{"MonoTouch.CoreImage.CIPhotoEffectChrome", "MonoTouch.CoreImage.CIPhotoEffectChrome, monotouch", 0},
	...
	{"MonoTouch.CoreImage.CIConvolution5X5", "MonoTouch.CoreImage.CIConvolution5X5, monotouch", 0},
	{"MonoTouch.CoreImage.CIConvolution9Horizontal", "MonoTouch.CoreImage.CIConvolution9Horizontal, monotouch", 0},
	{"MonoTouch.CoreImage.CIConvolution9Vertical", "MonoTouch.CoreImage.CIConvolution9Vertical, monotouch", 0},
	{"MonoTouch.CoreImage.CIAffineClamp", "MonoTouch.CoreImage.CIAffineClamp, monotouch", 0},
	{"MonoTouch.CoreImage.CIPerspectiveTransformWithExtent", "MonoTouch.CoreImage.CIPerspectiveTransformWithExtent, monotouch", 0},
	...
	{"MonoTouch.CoreImage.CIColorPolynomial", "MonoTouch.CoreImage.CIColorPolynomial, monotouch", 0},
	...
	{"MonoTouch.CoreImage.CIBumpDistortion", "MonoTouch.CoreImage.CIBumpDistortion, monotouch", 0},
	{"MonoTouch.CoreImage.CIDotScreen", "MonoTouch.CoreImage.CIDotScreen, monotouch", 0},
	{"MonoTouch.CoreImage.CIBumpDistortionLinear", "MonoTouch.CoreImage.CIBumpDistortionLinear, monotouch", 0},
	...
	{"MonoTouch.CoreImage.CIColorCubeWithColorSpace", "MonoTouch.CoreImage.CIColorCubeWithColorSpace, monotouch", 0},
	{"MonoTouch.CoreImage.CILightenBlendMode", "MonoTouch.CoreImage.CILightenBlendMode, monotouch", 0},
	{"MonoTouch.CoreImage.CIConvolution3X3", "MonoTouch.CoreImage.CIConvolution3X3, monotouch", 0},
	...
	{"NSTextStorage", "MonoTouch.UIKit.NSTextStorage, monotouch", 0},
	...
	{"SKLabelNode", "MonoTouch.SpriteKit.SKLabelNode, monotouch", 0},
	{"SKVideoNode", "MonoTouch.SpriteKit.SKVideoNode, monotouch", 0},
	{"SKCropNode", "MonoTouch.SpriteKit.SKCropNode, monotouch", 0},
	{"MonoTouch.SpriteKit.SKView+SKViewAppearance", "MonoTouch.SpriteKit.SKView+SKViewAppearance, monotouch", 0},
	{"SKView", "MonoTouch.SpriteKit.SKView, monotouch", 0},
	...
	{"MKTileOverlay", "MonoTouch.MapKit.MKTileOverlay, monotouch", 0},
	...
	{"SKShapeNode", "MonoTouch.SpriteKit.SKShapeNode, monotouch", 0},
	...
	{"SKEffectNode", "MonoTouch.SpriteKit.SKEffectNode, monotouch", 0},
	...
	{"SKSpriteNode", "MonoTouch.SpriteKit.SKSpriteNode, monotouch", 0},
	{"SKEmitterNode", "MonoTouch.SpriteKit.SKEmitterNode, monotouch", 0},
	...
	{"ZBarReaderViewController", "ZBar.ZBarReaderViewController, ZBar", 0},
	...
	{"MKCircleRenderer", "MonoTouch.MapKit.MKCircleRenderer, monotouch", 0},
	...
	{"MonoTouch.CoreImage.CISmoothLinearGradient", "MonoTouch.CoreImage.CISmoothLinearGradient, monotouch", 0},
	...
	{"MKPolylineRenderer", "MonoTouch.MapKit.MKPolylineRenderer, monotouch", 0},
	{"MKPolygonRenderer", "MonoTouch.MapKit.MKPolygonRenderer, monotouch", 0},
	...
	{"MonoTouch.UIKit.UIInputView+UIInputViewAppearance", "MonoTouch.UIKit.UIInputView+UIInputViewAppearance, monotouch", 0},
	{"UIInputView", "MonoTouch.UIKit.UIInputView, monotouch", 0},
	...
	{"Xamarin.iOS.ZBar.BarcodeScanDelegate", "Xamarin.iOS.ZBar.BarcodeScanDelegate, Xamarin.iOS.ZBar", 0},
	{"ZBar.ZBarReaderViewController+_ZBarReaderDelegate", "ZBar.ZBarReaderViewController+_ZBarReaderDelegate, ZBar", 0},
	...
	{"Xamarin.iOS.ZBar.ZBarScanner", "Xamarin.iOS.ZBar.ZBarScanner, Xamarin.iOS.ZBar", 0},
	...
	{"MonoTouch.CoreImage.CIBlendWithAlphaMask", "MonoTouch.CoreImage.CIBlendWithAlphaMask, monotouch", 0},
	...
	{"SKScene", "MonoTouch.SpriteKit.SKScene, monotouch", 0},
	...
	{"MKGeodesicPolyline", "MonoTouch.MapKit.MKGeodesicPolyline, monotouch", 0},
...
static MTClass __monotouch_classes [] = {
	...
	{"MonoTouch.CoreBluetooth.CBPeripheralManager+_CBPeripheralManagerDelegate", "NSObject", 1, 10, 0},
	...
	{"MonoTouch.SpriteKit.SKPhysicsWorld+_SKPhysicsContactDelegate", "NSObject", 1, 3, 0},
	...
	{"MonoTouch.UIKit.UIPageViewController+_UIPageViewControllerDelegate", "NSObject", 1, 6, 0},
	{"MonoTouch.UIKit.UIImage+DataWrapper", "NSData", 1, 2, 0},
	{"MonoTouch.CoreImage.CIDistortionFilter", "CIFilter", 1, 0, 0},
	{"__UIScreenEdgePanGestureRecognizer", "__UIGestureRecognizerToken", 1, 1, 0},
	...
	{"MonoTouch.UIKit.NSTextStorage+_NSTextStorageDelegate", "NSObject", 1, 3, 0},
	...
	{"MonoTouch.UIKit.UIView+UIViewAppearance", "NSObject", 1, 4, 0},
	...
	{"MonoTouch.AVFoundation.AVSpeechSynthesizer+_AVSpeechSynthesizerDelegate", "NSObject", 1, 7, 0},
	{"__UIGestureRecognizerParameterlessToken", "__UIGestureRecognizerToken", 1, 1, 0},
	{"MonoTouch.UIKit.UIPrintInteractionController+_UIPrintInteractionControllerDelegate", "NSObject", 1, 11, 0},
	...
	{"MonoTouch.Foundation.NSNetService+_NSNetServiceDelegate", "NSObject", 1, 10, 0},
	...
	{"MonoTouch.CoreImage.CIVignetteEffect", "CIFilter", 1, 1, 0},
	{"MonoTouch.CoreImage.CISRGBToneCurveToLinear", "CIFilter", 1, 1, 0},
	...
	{"MonoTouch.CoreImage.CILinearToSRGBToneCurve", "CIFilter", 1, 1, 0},
	{"MonoTouch.MapKit.MKMapView+_MKMapViewDelegate", "NSObject", 1, 23, 0},
	{"MonoTouch.CoreImage.CIPhotoEffect", "CIFilter", 1, 0, 0},
	{"MonoTouch.CoreImage.CIConvolutionCore", "CIFilter", 1, 0, 0},
	...
	{"MonoTouch.CoreImage.CIColorCrossPolynomial", "CIFilter", 1, 1, 0},
	...
	{"MonoTouch.CoreImage.CIColorClamp", "CIFilter", 1, 1, 0},
	...
	{"MonoTouch.CoreBluetooth.CBPeripheral+_CBPeripheralDelegate", "NSObject", 1, 14, 0},
	{"MonoTouch.CoreBluetooth.CBCentralManager+_CBCentralManagerDelegate", "NSObject", 1, 9, 0},
	{"MonoTouch.CoreImage.CIBlendFilter", "CIFilter", 1, 0, 0},
	{"MonoTouch.CoreImage.CIQRCodeGenerator", "CIFilter", 1, 1, 0},
	{"MonoTouch.UIKit.UICollisionBehavior+_UICollisionBehaviorDelegate", "NSObject", 1, 5, 0},
	...
	{"MonoTouch.CoreImage.CIPhotoEffectMono", "MonoTouch.CoreImage.CIPhotoEffect", 1, 1, 0},
	{"MonoTouch.CoreImage.CIPhotoEffectNoir", "MonoTouch.CoreImage.CIPhotoEffect", 1, 1, 0},
	{"MonoTouch.CoreImage.CIMaximumCompositing", "MonoTouch.CoreImage.CICompositingFilter", 1, 1, 0},
	{"MonoTouch.CoreImage.CIPhotoEffectProcess", "MonoTouch.CoreImage.CIPhotoEffect", 1, 1, 0},
	{"MonoTouch.CoreImage.CIPhotoEffectTonal", "MonoTouch.CoreImage.CIPhotoEffect", 1, 1, 0},
	...
	{"MonoTouch.CoreImage.CIPhotoEffectFade", "MonoTouch.CoreImage.CIPhotoEffect", 1, 1, 0},
	...
	{"MonoTouch.CoreImage.CIPhotoEffectInstant", "MonoTouch.CoreImage.CIPhotoEffect", 1, 1, 0},
	...
	{"ZBarDemoViewController", "UIViewController", 1, 6, 0},
	{"MonoTouch.CoreImage.CIPhotoEffectTransfer", "MonoTouch.CoreImage.CIPhotoEffect", 1, 1, 0},
	...
	{"MonoTouch.CoreImage.CIPhotoEffectChrome", "MonoTouch.CoreImage.CIPhotoEffect", 1, 1, 0},
	...
	{"MonoTouch.CoreImage.CIConvolution5X5", "MonoTouch.CoreImage.CIConvolutionCore", 1, 1, 0},
	{"MonoTouch.CoreImage.CIConvolution9Horizontal", "MonoTouch.CoreImage.CIConvolutionCore", 1, 1, 0},
	{"MonoTouch.CoreImage.CIConvolution9Vertical", "MonoTouch.CoreImage.CIConvolutionCore", 1, 1, 0},
	{"MonoTouch.CoreImage.CIAffineClamp", "MonoTouch.CoreImage.CIAffineFilter", 1, 1, 0},
	{"MonoTouch.CoreImage.CIPerspectiveTransformWithExtent", "MonoTouch.CoreImage.CIPerspectiveTransform", 1, 1, 0},
	{"MonoTouch.CoreImage.CILuminosityBlendMode", "MonoTouch.CoreImage.CIBlendFilter", 1, 1, 0},
	{"MonoTouch.CoreImage.CIColorPolynomial", "MonoTouch.CoreImage.CIColorCrossPolynomial", 1, 1, 0},
	...
	{"MonoTouch.CoreImage.CIBumpDistortion", "MonoTouch.CoreImage.CIDistortionFilter", 1, 1, 0},
	{"MonoTouch.CoreImage.CIDotScreen", "MonoTouch.CoreImage.CIScreenFilter", 1, 1, 0},
	{"MonoTouch.CoreImage.CIBumpDistortionLinear", "MonoTouch.CoreImage.CIDistortionFilter", 1, 1, 0},
	...
	{"MonoTouch.CoreImage.CIColorCubeWithColorSpace", "MonoTouch.CoreImage.CIColorCube", 1, 1, 0},
	{"MonoTouch.CoreImage.CILightenBlendMode", "MonoTouch.CoreImage.CIBlendFilter", 1, 1, 0},
	{"MonoTouch.CoreImage.CIConvolution3X3", "MonoTouch.CoreImage.CIConvolutionCore", 1, 1, 0},
	...
	{"MonoTouch.SpriteKit.SKView+SKViewAppearance", "MonoTouch.UIKit.UIView+UIViewAppearance", 1, 0, 0},
	...
	{"MonoTouch.UIKit.UITableViewHeaderFooterView+UITableViewHeaderFooterViewAppearance", "MonoTouch.UIKit.UIView+UIViewAppearance", 1, 0, 0},
	...
	{"MonoTouch.UIKit.UIVideoEditorController+_UIVideoEditorControllerDelegate", "NSObject", 1, 11, 0},
	...
	{"MonoTouch.CoreImage.CISmoothLinearGradient", "MonoTouch.CoreImage.CILinearGradient", 1, 1, 0},
	...
	{"MonoTouch.UIKit.UISearchBar+UISearchBarAppearance", "MonoTouch.UIKit.UIView+UIViewAppearance", 1, 20, 0},
	...
	{"MonoTouch.UIKit.UIInputView+UIInputViewAppearance", "MonoTouch.UIKit.UIView+UIViewAppearance", 1, 0, 0},
	{"MonoTouch.MapKit.MKAnnotationView+MKAnnotationViewAppearance", "MonoTouch.UIKit.UIView+UIViewAppearance", 1, 0, 0},
	{"MonoTouch.UIKit.UIImagePickerController+_UIImagePickerControllerDelegate", "NSObject", 1, 11, 0},
	{"MonoTouch.UIKit.UINavigationBar+UINavigationBarAppearance", "MonoTouch.UIKit.UIView+UIViewAppearance", 1, 16, 0},
	{"MonoTouch.UIKit.UIPickerView+UIPickerViewAppearance", "MonoTouch.UIKit.UIView+UIViewAppearance", 1, 0, 0},
	{"Xamarin.iOS.ZBar.BarcodeScanDelegate", "NSObject", 1, 3, 0},
	{"ZBar.ZBarReaderViewController+_ZBarReaderDelegate", "NSObject", 1, 2, 0},
	{"Xamarin.iOS.ZBar.ZBarScanner", "ZBarReaderViewController", 1, 1, 0},
	{"MonoTouch.UIKit.UIStepper+UIStepperAppearance", "MonoTouch.UIKit.UIControl+UIControlAppearance", 1, 8, 0},
	...
	{"MonoTouch.UIKit.UISegmentedControl+UISegmentedControlAppearance", "MonoTouch.UIKit.UIControl+UIControlAppearance", 1, 8, 0},
	...
	{"MonoTouch.CoreImage.CIBlendWithAlphaMask", "MonoTouch.CoreImage.CIBlendWithMask", 1, 1, 0},
	{"MonoTouch.UIKit.UIButton+UIButtonAppearance", "MonoTouch.UIKit.UIControl+UIControlAppearance", 1, 12, 0},
	...
	{"MonoTouch.UIKit.UISwitch+UISwitchAppearance", "MonoTouch.UIKit.UIControl+UIControlAppearance", 1, 8, 0},
	...
	{"MonoTouch.UIKit.UIRefreshControl+UIRefreshControlAppearance", "MonoTouch.UIKit.UIControl+UIControlAppearance", 1, 2, 0},
...
static MTMethod __monotouch_methods [] = {
	...
	{"peripheralManager:willRestoreState:","v@:@@",0, &native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBPeripheralManager__CBPeripheralManagerDelegate_WillRestoreState},
	...
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_SpriteKit_SKPhysicsWorld__SKPhysicsContactDelegate__ctor},
	{"didBeginContact:","v@:@",0, &native_to_managed_trampoline_MonoTouch_SpriteKit_SKPhysicsWorld__SKPhysicsContactDelegate_DidBeginContact},
	{"didEndContact:","v@:@",0, &native_to_managed_trampoline_MonoTouch_SpriteKit_SKPhysicsWorld__SKPhysicsContactDelegate_DidEndContact},
	...
	{"pageViewControllerSupportedInterfaceOrientations:","i@:@",0, &native_to_managed_trampoline_MonoTouch_UIKit_UIPageViewController__UIPageViewControllerDelegate_SupportedInterfaceOrientations},
	{"pageViewControllerPreferredInterfaceOrientationForPresentation:","i@:@",0, &native_to_managed_trampoline_MonoTouch_UIKit_UIPageViewController__UIPageViewControllerDelegate_GetPreferredInterfaceOrientationForPresentation},
	...
	{"target:","v@:@",0, &native_to_managed_trampoline_MonoTouch_UIKit_UIScreenEdgePanGestureRecognizer_Callback_Activated},
	...
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_UIKit_NSTextStorage__NSTextStorageDelegate__ctor},
	{"textStorage:willProcessEditing:range:changeInLength:","v@:@i{NSRange=ii}i",0, &native_to_managed_trampoline_MonoTouch_UIKit_NSTextStorage__NSTextStorageDelegate_WillProcessEditing},
	{"textStorage:didProcessEditing:range:changeInLength:","v@:@i{NSRange=ii}i",0, &native_to_managed_trampoline_MonoTouch_UIKit_NSTextStorage__NSTextStorageDelegate_DidProcessEditing},
	...
	{"tintColor","@@:",0, &native_to_managed_trampoline_MonoTouch_UIKit_UIView_UIViewAppearance_get_TintColor},
	{"setTintColor:","v@:@",0, &native_to_managed_trampoline_MonoTouch_UIKit_UIView_UIViewAppearance_set_TintColor},
	...
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_AVFoundation_AVSpeechSynthesizer__AVSpeechSynthesizerDelegate__ctor},
	{"speechSynthesizer:didStartSpeechUtterance:","v@:@@",0, &native_to_managed_trampoline_MonoTouch_AVFoundation_AVSpeechSynthesizer__AVSpeechSynthesizerDelegate_DidStartSpeechUtterance},
	{"speechSynthesizer:didFinishSpeechUtterance:","v@:@@",0, &native_to_managed_trampoline_MonoTouch_AVFoundation_AVSpeechSynthesizer__AVSpeechSynthesizerDelegate_DidFinishSpeechUtterance},
	{"speechSynthesizer:didPauseSpeechUtterance:","v@:@@",0, &native_to_managed_trampoline_MonoTouch_AVFoundation_AVSpeechSynthesizer__AVSpeechSynthesizerDelegate_DidPauseSpeechUtterance},
	{"speechSynthesizer:didContinueSpeechUtterance:","v@:@@",0, &native_to_managed_trampoline_MonoTouch_AVFoundation_AVSpeechSynthesizer__AVSpeechSynthesizerDelegate_DidContinueSpeechUtterance},
	{"speechSynthesizer:didCancelSpeechUtterance:","v@:@@",0, &native_to_managed_trampoline_MonoTouch_AVFoundation_AVSpeechSynthesizer__AVSpeechSynthesizerDelegate_DidCancelSpeechUtterance},
	{"speechSynthesizer:willSpeakRangeOfSpeechString:utterance:","v@:@{NSRange=ii}@",0, &native_to_managed_trampoline_MonoTouch_AVFoundation_AVSpeechSynthesizer__AVSpeechSynthesizerDelegate_WillSpeakRangeOfSpeechString},
	...
	{"printInteractionController:cutLengthForPaper:","f@:@@",0, &native_to_managed_trampoline_MonoTouch_UIKit_UIPrintInteractionController__UIPrintInteractionControllerDelegate_CutLengthForPaper},
	{"respondsToSelector:","B@::",0, &native_to_managed_trampoline_MonoTouch_UIKit_UIPrintInteractionController__UIPrintInteractionControllerDelegate_RespondsToSelector},
	...
	{"netService:didAcceptConnectionWithInputStream:outputStream:","v@:@@@",0, &native_to_managed_trampoline_MonoTouch_Foundation_NSNetService__NSNetServiceDelegate_DidAcceptConnection},
	...
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CIVignetteEffect__ctor},
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CISRGBToneCurveToLinear__ctor},
	...
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CILinearToSRGBToneCurve__ctor},
	...
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CIColorCrossPolynomial__ctor},
	...
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CIColorClamp__ctor},
	...
	{"init","@@:",0, &native_to_managed_trampoline_Xamarin_iOS_ZBar_Demo_AppDelegate__ctor},
	{"application:didFinishLaunchingWithOptions:","B@:@@",0, &native_to_managed_trampoline_Xamarin_iOS_ZBar_Demo_AppDelegate_FinishedLaunching},
	...
	{"peripheral:didModifyServices:","v@:@@",0, &native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBPeripheral__CBPeripheralDelegate_ModifiedServices},
	...
	{"centralManager:willRestoreState:","v@:@@",0, &native_to_managed_trampoline_MonoTouch_CoreBluetooth_CBCentralManager__CBCentralManagerDelegate_WillRestoreState},
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CIQRCodeGenerator__ctor},
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_UIKit_UICollisionBehavior__UICollisionBehaviorDelegate__ctor},
	{"collisionBehavior:beganContactForItem:withItem:atPoint:","v@:@@@{PointF=ff}",0, &native_to_managed_trampoline_MonoTouch_UIKit_UICollisionBehavior__UICollisionBehaviorDelegate_BeganContact},
	{"collisionBehavior:endedContactForItem:withItem:","v@:@@@",0, &native_to_managed_trampoline_MonoTouch_UIKit_UICollisionBehavior__UICollisionBehaviorDelegate_EndedContact},
	{"collisionBehavior:beganContactForItem:withBoundaryIdentifier:atPoint:","v@:@@@{PointF=ff}",0, &native_to_managed_trampoline_MonoTouch_UIKit_UICollisionBehavior__UICollisionBehaviorDelegate_BeganBoundaryContact},
	{"collisionBehavior:endedContactForItem:withBoundaryIdentifier:","v@:@@@",0, &native_to_managed_trampoline_MonoTouch_UIKit_UICollisionBehavior__UICollisionBehaviorDelegate_EndedBoundaryContact},
	...
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CIPhotoEffectMono__ctor},
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CIPhotoEffectNoir__ctor},
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CIMaximumCompositing__ctor},
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CIPhotoEffectProcess__ctor},
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CIPhotoEffectTonal__ctor},
	...
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CIPhotoEffectFade__ctor},
	...
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CIPhotoEffectInstant__ctor},
	...
	{"BarcodeResultLabel","@@:",0, &native_to_managed_trampoline_Xamarin_iOS_ZBar_Demo_ZBarDemoViewController_get_BarcodeResultLabel},
	{"setBarcodeResultLabel:","v@:@",0, &native_to_managed_trampoline_Xamarin_iOS_ZBar_Demo_ZBarDemoViewController_set_BarcodeResultLabel},
	{"ScanButton","@@:",0, &native_to_managed_trampoline_Xamarin_iOS_ZBar_Demo_ZBarDemoViewController_get_ScanButton},
	{"setScanButton:","v@:@",0, &native_to_managed_trampoline_Xamarin_iOS_ZBar_Demo_ZBarDemoViewController_set_ScanButton},
	{"init","@@:",0, &native_to_managed_trampoline_Xamarin_iOS_ZBar_Demo_ZBarDemoViewController__ctor},
	{"viewDidLoad","v@:",0, &native_to_managed_trampoline_Xamarin_iOS_ZBar_Demo_ZBarDemoViewController_ViewDidLoad},
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CIPhotoEffectTransfer__ctor},
	...
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CIPhotoEffectChrome__ctor},
	...
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CIConvolution5X5__ctor},
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CIConvolution9Horizontal__ctor},
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CIConvolution9Vertical__ctor},
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CIAffineClamp__ctor},
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CIPerspectiveTransformWithExtent__ctor},
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CILuminosityBlendMode__ctor},
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CIColorPolynomial__ctor},
	...
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CIBumpDistortion__ctor},
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CIDotScreen__ctor},
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CIBumpDistortionLinear__ctor},
	...
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CIColorCubeWithColorSpace__ctor},
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CILightenBlendMode__ctor},
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CIConvolution3X3__ctor},
	...
	{"barTintColor","@@:",0, &native_to_managed_trampoline_MonoTouch_UIKit_UIToolbar_UIToolbarAppearance_get_BarTintColor},
	{"setBarTintColor:","v@:@",0, &native_to_managed_trampoline_MonoTouch_UIKit_UIToolbar_UIToolbarAppearance_set_BarTintColor},
	...
	{"navigationControllerSupportedInterfaceOrientations:","i@:@",0, &native_to_managed_trampoline_MonoTouch_UIKit_UIVideoEditorController__UIVideoEditorControllerDelegate_SupportedInterfaceOrientations},
	{"navigationControllerPreferredInterfaceOrientationForPresentation:","i@:@",0, &native_to_managed_trampoline_MonoTouch_UIKit_UIVideoEditorController__UIVideoEditorControllerDelegate_GetPreferredInterfaceOrientation},
	{"navigationController:interactionControllerForAnimationController:","@@:@@",0, &native_to_managed_trampoline_MonoTouch_UIKit_UIVideoEditorController__UIVideoEditorControllerDelegate_GetInteractionControllerForAnimationController},
	{"navigationController:animationControllerForOperation:fromViewController:toViewController:","@@:@i@@",0, &native_to_managed_trampoline_MonoTouch_UIKit_UIVideoEditorController__UIVideoEditorControllerDelegate_GetAnimationControllerForOperation},
	{"respondsToSelector:","B@::",0, &native_to_managed_trampoline_MonoTouch_UIKit_UIVideoEditorController__UIVideoEditorControllerDelegate_RespondsToSelector},
	...
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CISmoothLinearGradient__ctor},
	...
	{"barTintColor","@@:",0, &native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar_UISearchBarAppearance_get_BarTintColor},
	{"setBarTintColor:","v@:@",0, &native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar_UISearchBarAppearance_set_BarTintColor},
	...
	{"setBackgroundImage:forBarPosition:barMetrics:","v@:@ii",0, &native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar_UISearchBarAppearance_SetBackgroundImage},
	{"backgroundImageForBarPosition:barMetrics:","@@:ii",0, &native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar_UISearchBarAppearance_BackgroundImageForBarPosition},
	{"setBackgroundImage:forBarMetrics:","v@:@i",0, &native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar_UISearchBarAppearance_SetBackgroundImage1},
	{"backgroundImageForBarMetrics:","@@:i",0, &native_to_managed_trampoline_MonoTouch_UIKit_UISearchBar_UISearchBarAppearance_BackgroundImageForBarMetrics},
	...
	{"barTintColor","@@:",0, &native_to_managed_trampoline_MonoTouch_UIKit_UITabBar_UITabBarAppearance_get_BarTintColor},
	{"setBarTintColor:","v@:@",0, &native_to_managed_trampoline_MonoTouch_UIKit_UITabBar_UITabBarAppearance_set_BarTintColor},
	...
	{"navigationControllerSupportedInterfaceOrientations:","i@:@",0, &native_to_managed_trampoline_MonoTouch_UIKit_UIImagePickerController__UIImagePickerControllerDelegate_SupportedInterfaceOrientations},
	{"navigationControllerPreferredInterfaceOrientationForPresentation:","i@:@",0, &native_to_managed_trampoline_MonoTouch_UIKit_UIImagePickerController__UIImagePickerControllerDelegate_GetPreferredInterfaceOrientation},
	{"navigationController:interactionControllerForAnimationController:","@@:@@",0, &native_to_managed_trampoline_MonoTouch_UIKit_UIImagePickerController__UIImagePickerControllerDelegate_GetInteractionControllerForAnimationController},
	{"navigationController:animationControllerForOperation:fromViewController:toViewController:","@@:@i@@",0, &native_to_managed_trampoline_MonoTouch_UIKit_UIImagePickerController__UIImagePickerControllerDelegate_GetAnimationControllerForOperation},
	{"respondsToSelector:","B@::",0, &native_to_managed_trampoline_MonoTouch_UIKit_UIImagePickerController__UIImagePickerControllerDelegate_RespondsToSelector},
	...
	{"barTintColor","@@:",0, &native_to_managed_trampoline_MonoTouch_UIKit_UINavigationBar_UINavigationBarAppearance_get_BarTintColor},
	{"setBarTintColor:","v@:@",0, &native_to_managed_trampoline_MonoTouch_UIKit_UINavigationBar_UINavigationBarAppearance_set_BarTintColor},
	{"backIndicatorImage","@@:",0, &native_to_managed_trampoline_MonoTouch_UIKit_UINavigationBar_UINavigationBarAppearance_get_BackIndicatorImage},
	{"setBackIndicatorImage:","v@:@",0, &native_to_managed_trampoline_MonoTouch_UIKit_UINavigationBar_UINavigationBarAppearance_set_BackIndicatorImage},
	{"backIndicatorTransitionMaskImage","@@:",0, &native_to_managed_trampoline_MonoTouch_UIKit_UINavigationBar_UINavigationBarAppearance_get_BackIndicatorTransitionMaskImage},
	{"setBackIndicatorTransitionMaskImage:","v@:@",0, &native_to_managed_trampoline_MonoTouch_UIKit_UINavigationBar_UINavigationBarAppearance_set_BackIndicatorTransitionMaskImage},
	...
	{"setBackgroundImage:forBarPosition:barMetrics:","v@:@ii",0, &native_to_managed_trampoline_MonoTouch_UIKit_UINavigationBar_UINavigationBarAppearance_SetBackgroundImage1},
	{"backgroundImageForBarPosition:barMetrics:","@@:ii",0, &native_to_managed_trampoline_MonoTouch_UIKit_UINavigationBar_UINavigationBarAppearance_GetBackgroundImage1},
	{"init","@@:",0, &native_to_managed_trampoline_Xamarin_iOS_ZBar_BarcodeScanDelegate__ctor},
	{"imagePickerController:didFinishPickingMediaWithInfo:","v@:@@",0, &native_to_managed_trampoline_Xamarin_iOS_ZBar_BarcodeScanDelegate_FinishedPickingMedia},
	{"imagePickerControllerDidCancel:","v@:@",0, &native_to_managed_trampoline_Xamarin_iOS_ZBar_BarcodeScanDelegate_Canceled},
	{"init","@@:",0, &native_to_managed_trampoline_ZBar_ZBarReaderViewController__ZBarReaderDelegate__ctor},
	{"readerControllerDidFailToRead:withRetry:","v@:@B",0, &native_to_managed_trampoline_ZBar_ZBarReaderViewController__ZBarReaderDelegate_BarcodeNotFound},
	{"init","@@:",0, &native_to_managed_trampoline_Xamarin_iOS_ZBar_ZBarScanner__ctor},
	...
	{"init","@@:",0, &native_to_managed_trampoline_MonoTouch_CoreImage_CIBlendWithAlphaMask__ctor},
...
int __monotouch_map_count = 921;
static int __monotouch_class_count = 283;
