...
extern void *mono_aot_module_XamariniOSZBarDemo_info;
extern void *mono_aot_module_monotouch_info;
extern void *mono_aot_module_mscorlib_info;
extern void *mono_aot_module_System_info;
extern void *mono_aot_module_System_Core_info;
extern void *mono_aot_module_System_Xml_info;
extern void *mono_aot_module_Xamarin_iOS_ZBar_info;
extern void *mono_aot_module_ZBar_info;

void monotouch_register_modules ()
{
	mono_aot_register_module (mono_aot_module_XamariniOSZBarDemo_info);
	mono_aot_register_module (mono_aot_module_monotouch_info);
	mono_aot_register_module (mono_aot_module_mscorlib_info);
	mono_aot_register_module (mono_aot_module_System_info);
	mono_aot_register_module (mono_aot_module_System_Core_info);
	mono_aot_register_module (mono_aot_module_System_Xml_info);
	mono_aot_register_module (mono_aot_module_Xamarin_iOS_ZBar_info);
	mono_aot_register_module (mono_aot_module_ZBar_info);
